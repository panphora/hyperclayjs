var hypercms=(()=>{var rt=Object.defineProperty;var zr=Object.getOwnPropertyDescriptor;var Wr=Object.getOwnPropertyNames;var Vr=Object.prototype.hasOwnProperty;var nt=(e,t)=>{for(var r in t)rt(e,r,{get:t[r],enumerable:!0})},Kr=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of Wr(t))!Vr.call(e,i)&&i!==r&&rt(e,i,{get:()=>t[i],enumerable:!(n=zr(t,i))||n.enumerable});return e};var Gr=e=>Kr(rt({},"__esModule",{value:!0}),e);var io={};nt(io,{cms:()=>ro,default:()=>no});var Ce=["textContent","innerText","innerHTML","outerHTML","value","checked","selected","disabled","readOnly","type","tagName","nodeName","nodeType","nodeValue","childElementCount","id","className","classList","baseURI","offsetWidth","offsetHeight","clientWidth","clientHeight","scrollWidth","scrollHeight","dataset","currentSrc","duration","paused","title","documentURI","contentType"],it=new Set(Ce),Dt=new Set(["textContent","innerText","innerHTML","value","checked","selected","disabled","readOnly","type","id","className","title"]),Pt=new Set(["tagName","nodeName","nodeType","nodeValue","childElementCount","classList","baseURI","documentURI","contentType","offsetWidth","offsetHeight","clientWidth","clientHeight","scrollWidth","scrollHeight","currentSrc","duration","paused","dataset"]);var Me={};nt(Me,{EmptyListInsert:()=>pe,MAX_RULE_DEPTH:()=>ne,MaxRuleDepthExceeded:()=>G,RuleTargetReadOnly:()=>fe,RulesParseError:()=>re,ShapeMismatch:()=>he,UnknownRulesVersion:()=>me,UpgradeAlreadyRegistered:()=>Re});var re=class extends Error{constructor(t,r){super(t),this.name="RulesParseError",this.cause=r}},me=class extends Error{constructor(t){super(`unknown rules version: ${t}. Library supports "1".`),this.name="UnknownRulesVersion",this.version=t}},ne=20,G=class extends Error{constructor(t){super(`rule depth exceeded ${ne} at path: ${t.join(".")}`),this.name="MaxRuleDepthExceeded",this.path=t}},he=class extends Error{constructor(t){super(`shape mismatch: ${t.length} field(s) failed validation`),this.name="ShapeMismatch",this.mismatches=t}},pe=class extends Error{constructor(t){super(`cannot add items to empty list at "${t.join(".")}" \u2014 no sibling to clone as template. Seed the list with a hidden item first.`),this.name="EmptyListInsert",this.path=t}},fe=class extends Error{constructor(t){super(`cannot write to read-only DOM property "${t}"`),this.name="RuleTargetReadOnly",this.target=t}},Re=class extends Error{constructor(){super("upgrade transform already registered; only one registration is allowed per page."),this.name="UpgradeAlreadyRegistered"}};function z(e,t,r,n={}){return ot(e,t,r,{depth:0,path:[]},n)}function ot(e,t,r,n,i){if(n.depth>ne)throw new G(n.path);if(typeof r=="string")return Yr(e,t,r,i);if(Array.isArray(r)){let[o,a]=r;return e.find(t,o,i).map((l,c)=>ot(e,l,a,{depth:n.depth+1,path:[...n.path,c]},i))}if(typeof r=="object"&&r!==null){let o={};for(let[a,s]of Object.entries(r))o[a]=ot(e,t,s,{depth:n.depth+1,path:[...n.path,a]},i);return o}return null}function Yr(e,t,r,n){if(r.endsWith("[]")){let o=r.slice(0,-2);return e.find(t,o,n).map(a=>e.text(a))}if(r.startsWith("@"))return Ht(e,t,r.slice(1));if(r.includes("@")){let o=r.lastIndexOf("@"),a=r.slice(0,o),s=r.slice(o+1),l=a?e.find(t,a,n):[t];return l.length===0?null:Ht(e,l[0],s)}if(r===".")return e.text(t);let i=e.find(t,r,n);return i.length===0?null:e.text(i[0])}function Ht(e,t,r){if(it.has(r)){let i=e.prop(t,r);return i==null?null:String(i)}let n=e.attr(t,r);return n||null}var Jr=.5;function st(e,t,r,n,i,o,a,s={}){let l=e.find(t,r,s);if(i.length===0){l.forEach(_=>e.remove(_));return}let c=i.length>l.length,u=l[0]||null;if(c&&!u&&(u=tn(e,t,r,s),!u))throw new pe(o.path);let m=l.map(_=>Xr(e,_,n,s)),h=null;if(u){h=e.clone(u),s.templateAttr&&e.removeAttr(h,s.templateAttr);let _=e.stripIds(h);_>0&&console.warn(`[hyper-html-api] stripped ${_} id attribute(s) from cloned template at "${o.path.join(".")||"(root)"}"`)}let k=Zr(i,m,n),x=l[0]||u,T=e.parent(x),y=l.length>0?en(e,T,x):0,M=new Set,E=i.map((_,C)=>{let S=k[C];if(S>=0)return M.add(S),l[S];let b=e.clone(h);return e.stripIds(b),b});l.forEach((_,C)=>{M.has(C)||e.remove(_)}),E.forEach((_,C)=>{let S=y+C;e.children(T).findIndex(d=>e.sameNode(d,_))!==S&&e.insertAt(T,_,S)}),E.forEach((_,C)=>{if(n===null){let S=i[C],b=S==null?"":String(S);e.text(_)!==b&&e.text(_,b)}else{let S=a(e,_,n,i[C],{depth:o.depth+1,path:[...o.path,C]},s);S&&S!==_&&(E[C]=S)}})}function Xr(e,t,r,n){return r===null?e.text(t):z(e,t,r,n)}function Zr(e,t,r){let n=new Array(e.length).fill(-1),i=new Set;return e.forEach((o,a)=>{let s=-1,l=-1;t.forEach((c,u)=>{if(i.has(u))return;let m=Qr(o,c,r),h=m===l&&s>=0?Math.abs(u-a)<Math.abs(s-a):!1;(m>l||h)&&(l=m,s=u)}),l>=Jr&&(n[a]=s,i.add(s))}),n}function Qr(e,t,r){if(r===null)return e===t?1:0;let n=Object.keys(r||{});if(n.length===0)return 0;let i=0;for(let o of n)JSON.stringify(e?.[o])===JSON.stringify(t?.[o])&&i++;return i/n.length}function en(e,t,r){let n=e.children(t);for(let i=0;i<n.length;i++)if(e.sameNode(n[i],r))return i;return-1}function tn(e,t,r,n){if(!n.templateAttr)return null;let i=t;for(;i;){let o=e.find(i,r,{includeRulesTag:!1});for(let a of o)if(e.attr(a,n.templateAttr)!=null)return a;i=e.parent(i)}return null}var Ut=new Set(["checked","selected","disabled","readOnly","paused"]);function Y(e,t,r,n,i={}){let o=[];if(at(r,n,[],o),o.length)throw new he(o);Te(e,t,r,n,{depth:0,path:[]},i)}function Te(e,t,r,n,i,o={}){if(i.depth>ne)throw new G(i.path);if(n===void 0)return t;if(typeof r=="string")return rn(e,t,r,n,i,o);if(Array.isArray(r)){let[a,s]=r;return st(e,t,a,s,n,i,Te,o),t}if(typeof r=="object"&&r!==null){for(let[a,s]of Object.entries(r)){let l=Te(e,t,s,n==null?n:n[a],{depth:i.depth+1,path:[...i.path,a]},o);l&&l!==t&&(t=l)}return t}return t}function rn(e,t,r,n,i,o){if(r.endsWith("[]")){let s=r.slice(0,-2);return st(e,t,s,null,n,i,Te,o),t}if(r.startsWith("@"))return Bt(e,t,r.slice(1),n);if(r.includes("@")){let s=r.lastIndexOf("@"),l=r.slice(0,s),c=r.slice(s+1),u=l?e.find(t,l,o):[t];return u.length===0||Bt(e,u[0],c,n),t}if(r===".")return e.text(t,n==null?"":String(n)),t;let a=e.find(t,r,o);return a.length===0||e.text(a[0],n==null?"":String(n)),t}function Bt(e,t,r,n){if(Pt.has(r))throw new fe(r);if(r==="outerHTML"){let i=n==null?"":String(n);return e.replaceWith(t,i)}return Dt.has(r)?(e.prop(t,r,nn(r,n)),t):(e.attr(t,r,n==null?"":String(n)),t)}function nn(e,t){return t==null?Ut.has(e)?!1:"":Ut.has(e)?!!t:t}function at(e,t,r,n){if(t!==void 0){if(typeof e=="string"){if(e.endsWith("[]")){Array.isArray(t)?t.forEach((i,o)=>{typeof i=="object"&&i!==null&&n.push({path:ge([...r,o]),expected:"scalar",got:be(i)})}):n.push({path:ge(r),expected:"array",got:be(t)});return}t!==null&&typeof t=="object"&&n.push({path:ge(r),expected:"scalar",got:be(t)});return}if(Array.isArray(e)){if(!Array.isArray(t)){n.push({path:ge(r),expected:"array",got:be(t)});return}let i=e[1];t.forEach((o,a)=>at(i,o,[...r,a],n));return}if(typeof e=="object"&&e!==null){if(t===null||Array.isArray(t)||typeof t!="object"){n.push({path:ge(r),expected:"object",got:be(t)});return}for(let[i,o]of Object.entries(e))at(o,t[i],[...r,i],n)}}}function be(e){return e===null?"null":Array.isArray(e)?"array":typeof e}function ge(e){return e.join(".")}function lt(e){try{return JSON.parse(e)}catch(t){throw new re(`Invalid strict JSON: ${t.message}`,t)}}function ye(e){try{return JSON.parse(e)}catch{}let t={BRACE_OPEN:"{",BRACE_CLOSE:"}",BRACKET_OPEN:"[",BRACKET_CLOSE:"]",COLON:":",COMMA:",",STRING:"STRING",SELECTOR:"SELECTOR",IDENTIFIER:"IDENTIFIER",NUMBER:"NUMBER",BOOLEAN:"BOOLEAN"};function r(i){let o=[],a=0;for(;a<i.length;){let s=i[a];if(/\s/.test(s)){a++;continue}if("{}".includes(s)){o.push({type:s,value:s}),a++;continue}if(s==="["){let m=!1,h=a+1;for(;h<i.length&&/\s/.test(i[h]);)h++;if(h<i.length&&/[a-zA-Z_]/.test(i[h])&&(m=!0),!m){o.push({type:s,value:s}),a++;continue}}if(s==="]"){o.push({type:s,value:s}),a++;continue}if(s===":"){o.push({type:t.COLON,value:s}),a++;continue}if(s===","){o.push({type:t.COMMA,value:s}),a++;continue}if(s==='"'||s==="'"){let m=s,h=a+1;for(;h<i.length&&i[h]!==m;)i[h]==="\\"&&h++,h++;o.push({type:t.STRING,value:i.substring(a+1,h),quoted:!0,sourceQuote:m}),a=h+1;continue}let l=a,c;for(;l<i.length&&!/[{},]/.test(i[l]);)if(i[l]===":"){let m=[":first",":last",":nth-child",":nth-of-type",":first-child",":last-child",":first-of-type",":last-of-type",":only-child",":only-of-type",":hover",":focus",":active",":visited",":disabled",":enabled",":checked",":empty",":root",":target",":not",":before",":after",":nth-last-child",":nth-last-of-type"],h=!1;for(let k of m){let x=k.substring(1);if(i.substring(l+1,l+1+x.length)===x){h=!0,l+=x.length;break}}if(!h)break}else if(i[l]==="["){for(l++;l<i.length&&i[l]!=="]";){if(i[l]==='"'||i[l]==="'"){let m=i[l];for(l++;l<i.length&&i[l]!==m;)i[l]==="\\"&&l++,l++}l++}l<i.length&&i[l]==="]"&&l++}else l++;c=i.substring(a,l);let u=t.IDENTIFIER;/^-?\d+(\.\d+)?$/.test(c)?u=t.NUMBER:c==="true"||c==="false"||c==="null"?u=t.BOOLEAN:/^[.#@\[]|[.#@\[]| /.test(c)&&(u=t.SELECTOR),o.push({type:u,value:c,quoted:!1}),a=l}return o}function n(i){let o="";for(let a=0;a<i.length;a++){let s=i[a];if("{}".includes(s.type)||"[]".includes(s.type)){o+=s.value;continue}if(s.type===t.COLON){o+=s.value;continue}if(s.type===t.COMMA){let l=i[a+1];if(l&&(l.type==="}"||l.type==="]"))continue;o+=s.value;continue}if(s.type===t.STRING&&s.quoted){let l=s.value;s.sourceQuote==="'"&&(l=l.replace(/\\'/g,"'"),l=l.replace(/(\\*)"/g,(c,u)=>u.length%2===0?u+'\\"':c)),o+=`"${l}"`;continue}if(s.type===t.NUMBER||s.type===t.BOOLEAN){o+=s.value;continue}if(s.type===t.SELECTOR||s.type===t.IDENTIFIER){o+=`"${s.value}"`;continue}o+=`"${s.value}"`}return o}try{let i=r(e),o=n(i);return JSON.parse(o)}catch(i){throw new re("Invalid extraction rules syntax: "+i.message,i)}}var on="1",zt=/^[a-zA-Z0-9_-]+$/;function J(e,t,r){let n;if(r===void 0)n="script[data-rules-name]";else{if(typeof r!="string"||!zt.test(r))throw new Error(`hyper-html-api: invalid rules token ${JSON.stringify(r)} (must match ${zt})`);n=`script[data-rules-name~="${r}"]`}let i=e.find(t,n,{includeRulesTag:!0});if(i.length===0)return null;r!==void 0&&i.length>1&&console.warn(`hyper-html-api: ${i.length} rules tags match data-rules-name~="${r}"; using the first.`);let o=i[0],a=e.attr(o,"data-rules-version");if(a!==on)throw new me(a);return{rules:ye(e.text(o)),tagNode:o}}function ct(e,t,r){if(r&&typeof r=="object")return{rules:r,tagNode:null};if(typeof r=="string"){let n=t&&t.ownerDocument?t.ownerDocument:t;return J(e,n,r)}return null}function Wt(e,t,r,n){let i=ct(e,t,r);if(!i){let s=typeof r=="string"?`data-rules-name~="${r}"`:"the provided rules object";throw new Error(`hyper-html-api: could not resolve rules for ${s}`)}let{rules:o,tagNode:a}=i;return{rules:o,tagNode:a,get:()=>z(e,t,o,n),set:s=>Y(e,t,o,s,n)}}var Gt={includeClasses:!0,includeAttributes:["href","src","name","type","role","aria-label","alt","title"],excludeAttributePrefixes:["data-morph-","data-hyper-","data-im-"],textHintLength:64,excludeIds:!0,maxPathDepth:4,landmarks:["HEADER","NAV","MAIN","ASIDE","FOOTER","SECTION","ARTICLE"],weights:{signature:100,pathSegment:10,textMatch:20,textMismatch:25,uniqueCandidate:50,positionPenalty:1,slotMatch:30},minConfidence:101};function ln(e){let t=5381;for(let r=0;r<e.length;r++)t=(t<<5)+t^e.charCodeAt(r);return Math.abs(t).toString(36)}function cn(e){if(e.classList&&e.classList.length>0)return Array.from(e.classList).sort().join(" ");let t=e.getAttribute?.("class");return t?t.split(/\s+/).filter(Boolean).sort().join(" "):""}function un(e,t){let r=[];for(let n of e.attributes||[]){let i=n.name;i==="id"||i==="class"||t.excludeAttributePrefixes.some(o=>i.startsWith(o))||t.includeAttributes.includes(i)&&r.push(`${i}=${n.value}`)}return r.sort().join("|")}function dn(e,t){return(e.textContent||"").replace(/\s+/g," ").trim().slice(0,t.textHintLength)}function mn(e,t){let r=[e.tagName];return t.includeClasses&&r.push(cn(e)),r.push(un(e,t)),ln(r.join("|"))}function hn(e){let t=e.tagName,r=1,n=e.previousElementSibling;for(;n;)n.tagName===t&&r++,n=n.previousElementSibling;return r}function pn(e,t){return e.id||e.getAttribute?.("role")?!0:t.landmarks.includes(e.tagName)}function fn(e){if(e.id)return`#${e.id}`;let t=e.getAttribute?.("role");return t?`@${t}`:e.tagName}function bn(e,t){let r=[],n=e;for(;n&&n.tagName&&r.length<t.maxPathDepth;){let i=`${n.tagName}:${hn(n)}`;if(r.unshift(i),n!==e&&pn(n,t)){r.unshift(fn(n));break}n=n.parentElement}return r}function gn(e,t){let r=0,n=e.length-1,i=t.length-1;for(;n>=0&&i>=0&&e[n]===t[i];)r++,n--,i--;return r}function H(e,t,r){if(r.has(e))return r.get(e);let n={signature:mn(e,t),path:bn(e,t),textHint:dn(e,t)};return r.set(e,n),n}function Zt(e,t,r,n){if(n.has(e))return n.get(e);let i=new Map,o=e.querySelectorAll("*"),a=0;for(let s of o){let l=H(s,t,r);l.domIndex=a++,i.has(l.signature)||i.set(l.signature,[]),i.get(l.signature).push(s)}return n.set(e,i),i}function yn(e,t,r){r.delete(e),t.delete(e);let n=e.querySelectorAll("*");for(let i of n)t.delete(i)}function ut(e,t,r,n,i){let o=H(e,r,n),a=H(t,r,n),s=r.weights,l={},c=0;if(o.signature!==a.signature)return{score:0,breakdown:{rejected:"signature mismatch"}};c+=s.signature,l.signature=s.signature;let m=gn(o.path,a.path)*s.pathSegment;c+=m,l.path=m;let h=!0;if(o.textHint&&a.textHint?o.textHint===a.textHint?(c+=s.textMatch,l.text=s.textMatch):(c-=s.textMismatch,l.text=-s.textMismatch,h=!1):o.textHint!==a.textHint&&(c-=s.textMismatch,l.text=-s.textMismatch,h=!1),i.candidateCount===1&&h&&(c+=s.uniqueCandidate,l.unique=s.uniqueCandidate),typeof o.domIndex=="number"&&typeof a.domIndex=="number"){let k=Math.abs(o.domIndex-a.domIndex),x=Math.min(k*s.positionPenalty,20);c-=x,l.drift=-x}return{score:c,breakdown:l}}function Yt(e,t,r,n,i){if(r.excludeIds&&e.id)return null;let o=Zt(t,r,n,i),a=H(e,r,n);if(typeof a.domIndex!="number"){let h=0,k=e.previousElementSibling;for(;k;)h++,k=k.previousElementSibling;a.domIndex=h}let s=o.get(a.signature)||[],l=r.excludeIds?s.filter(h=>!h.id):s;if(l.length===0)return null;let c=null,u=0,m=null;for(let h of l){let{score:k,breakdown:x}=ut(e,h,r,n,{candidateCount:l.length});k>u&&(u=k,c=h,m=x)}return u<r.minConfidence?null:{element:c,confidence:u,breakdown:m}}function kn(e,t,r,n){let i=[],o=r.weights.signature+r.weights.slotMatch,a={slot:o};function s(m){if(m.children)return m.children;let h=m.childNodes;if(!h)return[];let k=[];for(let x=0;x<h.length;x++)h[x].nodeType===1&&k.push(h[x]);return k}function l(m,h){let k=s(m),x=s(h);if(k.length===x.length)for(let T=0;T<k.length;T++){let y=k[T],M=x[T];if(r.excludeIds&&(y.id||M.id)||y.tagName!==M.tagName)continue;let E=H(y,r,n).signature,_=H(M,r,n).signature;E!==_&&i.push({newEl:y,oldEl:M,score:o,breakdown:a}),l(y,M)}}function c(m,h){for(;;){if(m.tagName===h.tagName)return[m,h];let k=s(m);if(!m.tagName&&k.length===1){m=k[0];continue}let x=s(h);if(x.length===1&&x[0].tagName===m.tagName){h=x[0];continue}return null}}let u=c(e,t);return u&&l(u[0],u[1]),i}function Jt(e,t,r,n,i){let o=t.querySelectorAll("*"),a=Zt(e,r,n,i),s=0;for(let m of o){let h=H(m,r,n);h.domIndex=s++}let l=[];for(let m of o){if(r.excludeIds&&m.id)continue;let h=H(m,r,n),k=a.get(h.signature)||[],x=r.excludeIds?k.filter(T=>!T.id):k;for(let T of x){let{score:y,breakdown:M}=ut(m,T,r,n,{candidateCount:x.length});y>=r.minConfidence&&l.push({newEl:m,oldEl:T,score:y,breakdown:M})}}if(r.weights.slotMatch>0){let m=kn(t,e,r,n);for(let h of m)l.push(h)}l.sort((m,h)=>h.score-m.score);let c=new Map,u=new Set;for(let{newEl:m,oldEl:h}of l)c.has(m)||u.has(h)||(c.set(m,h),u.add(h));return c}function Xt(e,t,r,n){let i=H(e,r,n),o=H(t,r,n),{score:a,breakdown:s}=ut(e,t,r,n,{candidateCount:1});return{matches:a>=r.minConfidence,score:a,breakdown:s,newMeta:{signature:i.signature,path:i.path,textHint:i.textHint},oldMeta:{signature:o.signature,path:o.path,textHint:o.textHint}}}function Qt(e={}){let t={...Gt,...e,weights:{...Gt.weights,...e.weights}},r=new WeakMap,n=new WeakMap;return{findMatch:(i,o)=>Yt(i,o,t,r,n),computeMatches:(i,o)=>Jt(i,o,t,r,n),explain:(i,o)=>Xt(i,o,t,r),invalidate:i=>yn(i,r,n),session:()=>{let i=new WeakMap,o=new WeakMap;return{findMatch:(a,s)=>Yt(a,s,t,i,o),computeMatches:(a,s)=>Jt(a,s,t,i,o),explain:(a,s)=>Xt(a,s,t,i)}},getConfig:()=>({...t})}}var vn=Qt(),dt=(function(){"use strict";let e=()=>{};function t(y){if(!(y instanceof Element))return!1;if(y.hasAttribute("save-ignore"))return!0;if(y.tagName==="LINK"||y.tagName==="SCRIPT"){let M=y.getAttribute("src")||y.getAttribute("href")||"";if(M.startsWith("chrome-extension://")||M.startsWith("moz-extension://")||M.startsWith("safari-web-extension://"))return!0}return!1}function r(y,M){if(M!=="smart")return y.outerHTML;let E=y.getAttribute("src"),_=y.getAttribute("type")||"text/javascript";if(E)try{let C=new URL(E,window.location.href);return`ext:${_}:${C.origin}${C.pathname}${C.search}`}catch{return`ext:${_}:${E}`}else{let C=y.textContent.trim(),S=5381;for(let b=0;b<C.length;b++)S=(S<<5)+S^C.charCodeAt(b);return`inline:${_}:${Math.abs(S).toString(36)}`}}let n={morphStyle:"outerHTML",callbacks:{beforeNodeAdded:e,afterNodeAdded:e,beforeNodeMorphed:e,afterNodeMorphed:e,beforeNodeRemoved:e,afterNodeRemoved:e,beforeAttributeUpdated:e},head:{style:"merge",shouldPreserve:y=>y.getAttribute("im-preserve")==="true",shouldReAppend:y=>y.getAttribute("im-re-append")==="true",shouldRemove:e,afterHeadMorphed:e},scripts:{handle:!1,matchMode:"outerHTML",shouldPreserve:y=>y.getAttribute("im-preserve")==="true",shouldReAppend:y=>y.getAttribute("im-re-append")==="true",shouldRemove:e,afterScriptsHandled:e},restoreFocus:!0},i={computeMatches(y,M){let{computeMatches:E}=vn.session();return E(y,M)}};function o(y,M,E={}){y=x(y);let _=T(M),C=k(y,_,E),S=C.scripts.matchMode,b=new Set(Array.from(y.querySelectorAll("script")).map(p=>r(p,S))),w=s(C,()=>u(C,y,_,p=>p.morphStyle==="innerHTML"?(l(p,y,_),Array.from(y.childNodes)):a(p,y,_)));C.pantry.remove();let d=h(y,b,C);return d.length>0?w instanceof Promise?w.then(p=>Promise.all(d).then(()=>p)):Promise.all(d).then(()=>w):w}function a(y,M,E){let _=T(M);return l(y,_,E,M,M.nextSibling),Array.from(_.childNodes)}function s(y,M){if(!y.config.restoreFocus)return M();let E=document.activeElement;if(!(E instanceof HTMLInputElement||E instanceof HTMLTextAreaElement))return M();let{id:_,selectionStart:C,selectionEnd:S}=E,b=M();return _&&_!==document.activeElement?.getAttribute("id")&&(E=y.target.querySelector(`[id="${_}"]`),E?.focus()),E&&!E.selectionEnd&&S!=null&&E.setSelectionRange(C,S),b}let l=(function(){function y(d,p,g,f=null,v=null){p instanceof HTMLTemplateElement&&g instanceof HTMLTemplateElement&&(p=p.content,g=g.content),f||=p.firstChild;for(let A of g.childNodes){if(t(A))continue;if(f&&f!=v){let O=E(d,A,f,v);if(O){O!==f&&C(d,f,O),c(O,A,d),f=O.nextSibling;continue}}if(A instanceof Element){let O=A.getAttribute("id");if(d.persistentIds.has(O)){let j=S(p,O,f,d);c(j,A,d),f=j.nextSibling;continue}if(!d.idMap.has(A)){let j=d.hyperMatches.get(A);if(j&&!d.idMap.has(j)){w(p,j,f),c(j,A,d),f=j.nextSibling;continue}}}let R=M(p,A,f,d);R&&(f=R.nextSibling)}for(;f&&f!=v;){let A=f;f=f.nextSibling,t(A)||_(d,A)}}function M(d,p,g,f){if(f.callbacks.beforeNodeAdded(p)===!1)return null;if(f.idMap.has(p)){let v=document.createElement(p.tagName);return d.insertBefore(v,g),c(v,p,f),f.callbacks.afterNodeAdded(v),v}else{let v=document.importNode(p,!0);return d.insertBefore(v,g),f.callbacks.afterNodeAdded(v),v}}let E=(function(){function d(f,v,A,R){let O=v instanceof Element&&!f.idMap.has(v)?f.hyperMatches.get(v):null,j=null,D=v.nextSibling,de=0,N=A;for(;N&&N!=R;){if(g(N,v)){if(p(f,N,v)||N===O&&!f.idMap.has(N))return N;if(j===null){let ee=N instanceof Element&&f.hyperMatchedOldElements.has(N);!f.idMap.has(N)&&!ee&&(j=N)}}if(j===null&&D&&g(N,D)&&(de++,D=D.nextSibling,de>=2&&(j=void 0)),f.activeElementAndParents.includes(N))break;N=N.nextSibling}return j||null}function p(f,v,A){let R=f.idMap.get(v),O=f.idMap.get(A);if(!O||!R)return!1;for(let j of R)if(O.has(j))return!0;return!1}function g(f,v){let A=f,R=v;return A.nodeType===R.nodeType&&A.tagName===R.tagName&&(!A.getAttribute?.("id")||A.getAttribute?.("id")===R.getAttribute?.("id"))}return d})();function _(d,p){let g=p instanceof Element&&d.hyperMatchedOldElements.has(p)&&!d.idMap.has(p);if(d.idMap.has(p)||g)w(d.pantry,p,null);else{if(d.callbacks.beforeNodeRemoved(p)===!1)return;p.parentNode?.removeChild(p),d.callbacks.afterNodeRemoved(p)}}function C(d,p,g){let f=p;for(;f&&f!==g;){let v=f;f=f.nextSibling,t(v)||_(d,v)}return f}function S(d,p,g,f){let v=f.target.getAttribute?.("id")===p&&f.target||f.target.querySelector(`[id="${p}"]`)||f.pantry.querySelector(`[id="${p}"]`);return b(v,f),w(d,v,g),v}function b(d,p){let g=d.getAttribute("id");for(;d=d.parentNode;){let f=p.idMap.get(d);f&&(f.delete(g),f.size||p.idMap.delete(d))}}function w(d,p,g){if(d.moveBefore)try{d.moveBefore(p,g)}catch{d.insertBefore(p,g)}else d.insertBefore(p,g)}return y})(),c=(function(){function y(b,w,d){return d.ignoreActive&&b===document.activeElement?null:(d.callbacks.beforeNodeMorphed(b,w)===!1||(b instanceof HTMLHeadElement&&d.head.ignore||(b instanceof HTMLHeadElement&&d.head.style!=="morph"?m(b,w,d):(M(b,w,d),S(b,d)||l(d,b,w))),d.callbacks.afterNodeMorphed(b,w)),b)}function M(b,w,d){let p=w.nodeType;if(p===1){let g=b,f=w,v=g.attributes,A=f.attributes;for(let R of A)C(R.name,g,"update",d)||g.getAttribute(R.name)!==R.value&&g.setAttribute(R.name,R.value);for(let R=v.length-1;0<=R;R--){let O=v[R];if(O&&!f.hasAttribute(O.name)){if(C(O.name,g,"remove",d))continue;g.removeAttribute(O.name)}}S(g,d)||E(g,f,d)}(p===8||p===3)&&b.nodeValue!==w.nodeValue&&(b.nodeValue=w.nodeValue)}function E(b,w,d){if(b instanceof HTMLInputElement&&w instanceof HTMLInputElement&&w.type!=="file"){let p=w.value,g=b.value;_(b,w,"checked",d),_(b,w,"disabled",d),d.formStateSync==="property"?g!==p&&(C("value",b,"update",d)||(b.value=p)):w.hasAttribute("value")?g!==p&&(C("value",b,"update",d)||(b.setAttribute("value",p),b.value=p)):C("value",b,"remove",d)||(b.value="",b.removeAttribute("value"))}else if(b instanceof HTMLOptionElement&&w instanceof HTMLOptionElement)_(b,w,"selected",d);else if(b instanceof HTMLTextAreaElement&&w instanceof HTMLTextAreaElement){let p=w.value,g=b.value;if(C("value",b,"update",d))return;p!==g&&(b.value=p),b.firstChild&&b.firstChild.nodeValue!==p&&(b.firstChild.nodeValue=p)}}function _(b,w,d,p){let g=w[d],f=b[d];if(g!==f){let v=C(d,b,"update",p);if(v||(b[d]=w[d]),p.formStateSync==="property")return;g?v||b.setAttribute(d,""):C(d,b,"remove",p)||b.removeAttribute(d)}}function C(b,w,d,p){return b==="value"&&p.ignoreActiveValue&&w===document.activeElement?!0:p.callbacks.beforeAttributeUpdated(b,w,d)===!1}function S(b,w){return!!w.ignoreActiveValue&&b===document.activeElement&&b!==document.body}return y})();function u(y,M,E,_){if(y.head.block){let C=M.querySelector("head"),S=E.querySelector("head");if(C&&S){let b=m(C,S,y);return Promise.all(b).then(()=>{let w=Object.assign(y,{head:{block:!1,ignore:!0}});return _(w)})}}return _(y)}function m(y,M,E){let _=[],C=[],S=[],b=[],w=E.scripts.matchMode,d=f=>{if(f.tagName==="SCRIPT")return r(f,w);if(f.tagName==="LINK"&&w==="smart"){let v=f.getAttribute("href");if(v)try{let A=new URL(v,window.location.href);return`link:${f.getAttribute("rel")||""}:${A.origin}${A.pathname}${A.search}`}catch{}}return f.outerHTML},p=new Map;for(let f of M.children)t(f)||p.set(d(f),f);for(let f of y.children){let v=d(f),A=p.has(v),R=E.head.shouldReAppend(f),O=E.head.shouldPreserve(f);A||O?R?C.push(f):(p.delete(v),S.push(f)):E.head.style==="append"?R&&(C.push(f),b.push(f)):E.head.shouldRemove(f)!==!1&&!t(f)&&C.push(f)}b.push(...p.values());let g=[];for(let f of b){let v=document.createRange().createContextualFragment(f.outerHTML).firstChild;if(E.callbacks.beforeNodeAdded(v)!==!1){if("href"in v&&v.href||"src"in v&&v.src){let A,R=new Promise(function(O){A=O});v.addEventListener("load",function(){A()}),g.push(R)}y.appendChild(v),E.callbacks.afterNodeAdded(v),_.push(v)}}for(let f of C)E.callbacks.beforeNodeRemoved(f)!==!1&&(y.removeChild(f),E.callbacks.afterNodeRemoved(f));return E.head.afterHeadMorphed(y,{added:_,kept:S,removed:C}),g}function h(y,M,E){if(!E.scripts.handle)return[];let _=[],C=[],S=[],b=[],w=E.scripts.matchMode,d=Array.from(y.querySelectorAll("script"));for(let g of d){let f=r(g,w),v=M.has(f),A=E.scripts.shouldPreserve(g),R=E.scripts.shouldReAppend(g);v||A?R?(C.push(g),b.push(g)):S.push(g):b.push(g)}for(let g of M){let f=d.some(v=>v.outerHTML===g)}let p=[];for(let g of b){if(E.callbacks.beforeNodeAdded(g)===!1)continue;let f=document.createRange().createContextualFragment(g.outerHTML).firstChild;if(f.src){let v,A=new Promise(function(R){v=R});f.addEventListener("load",function(){v()}),f.addEventListener("error",function(){v()}),p.push(A)}g.replaceWith(f),E.callbacks.afterNodeAdded(f),_.push(f)}return E.scripts.afterScriptsHandled(y,{added:_,kept:S,removed:C}),p}let k=(function(){function y(d,p,g){let{persistentIds:f,idMap:v}=b(d,p),A=i.computeMatches(d,p);if(typeof g.key=="function"){let D=new Map,de=new Set,N=I=>{let q=g.key(I);q!=null&&(D.has(q)?de.add(q):D.set(q,I))};d instanceof Element&&N(d);for(let I of d.querySelectorAll("*"))N(I);for(let I of de)D.delete(I);let ee=new Map;for(let[I,q]of A)ee.set(q,I);let Qe=p.__hyperMorphRoot||p,Ee=new Map,Ft=new Set,$t=I=>{let q=g.key(I);q!=null&&(Ee.has(q)?Ft.add(q):Ee.set(q,I))};Qe instanceof Element&&$t(Qe);for(let I of Qe.querySelectorAll("*"))$t(I);for(let I of Ft)Ee.delete(I);for(let[I,q]of Ee){let te=D.get(I);if(!te||te.tagName!==q.tagName)continue;let et=ee.get(te);et&&et!==q&&A.delete(et);let tt=A.get(q);tt&&tt!==te&&ee.delete(tt),A.set(q,te),ee.set(te,q)}}let R=new Set;for(let D of A.values())R.add(D);let O=M(g),j=O.morphStyle||"outerHTML";if(!["innerHTML","outerHTML"].includes(j))throw`Do not understand how to morph style ${j}`;return{target:d,newContent:p,config:O,morphStyle:j,ignoreActive:O.ignoreActive,ignoreActiveValue:O.ignoreActiveValue,restoreFocus:O.restoreFocus,formStateSync:O.formStateSync||"attribute",idMap:v,persistentIds:f,hyperMatches:A,hyperMatchedOldElements:R,pantry:E(),activeElementAndParents:_(d),callbacks:O.callbacks,head:O.head,scripts:O.scripts}}function M(d){let p=Object.assign({},n);return Object.assign(p,d),p.callbacks=Object.assign({},n.callbacks,d.callbacks),p.head=Object.assign({},n.head,d.head),p.scripts=Object.assign({},n.scripts,d.scripts),p}function E(){let d=document.createElement("div");return d.hidden=!0,document.body.insertAdjacentElement("afterend",d),d}function _(d){let p=[],g=document.activeElement;if(g?.tagName!=="BODY"&&d.contains(g))for(;g&&(p.push(g),g!==d);)g=g.parentElement;return p}function C(d){let p=Array.from(d.querySelectorAll("[id]"));return d.getAttribute?.("id")&&p.push(d),p}function S(d,p,g,f){for(let v of f){let A=v.getAttribute("id");if(p.has(A)){let R=v;for(;R;){let O=d.get(R);if(O==null&&(O=new Set,d.set(R,O)),O.add(A),R===g)break;R=R.parentElement}}}}function b(d,p){let g=C(d),f=C(p),v=w(g,f),A=new Map;S(A,v,d,g);let R=p.__hyperMorphRoot||p;return S(A,v,R,f),{persistentIds:v,idMap:A}}function w(d,p){let g=new Set,f=new Map;for(let{id:A,tagName:R}of d)f.has(A)?g.add(A):f.set(A,R);let v=new Set;for(let{id:A,tagName:R}of p)v.has(A)?g.add(A):f.get(A)===R&&v.add(A);for(let A of g)v.delete(A);return v}return y})(),{normalizeElement:x,normalizeParent:T}=(function(){let y=new WeakSet;function M(S){return S instanceof Document?S.documentElement:S}function E(S){if(S==null)return document.createElement("div");if(typeof S=="string")return E(C(S));if(y.has(S))return S;if(S instanceof Node){if(S.parentNode)return new _(S);{let b=document.createElement("div");return b.append(S),b}}else{let b=document.createElement("div");for(let w of[...S])b.append(w);return b}}class _{constructor(b){this.originalNode=b,this.realParentNode=b.parentNode,this.previousSibling=b.previousSibling,this.nextSibling=b.nextSibling}get childNodes(){let b=[],w=this.previousSibling?this.previousSibling.nextSibling:this.realParentNode.firstChild;for(;w&&w!=this.nextSibling;)b.push(w),w=w.nextSibling;return b}querySelectorAll(b){return this.childNodes.reduce((w,d)=>{if(d instanceof Element){d.matches(b)&&w.push(d);let p=d.querySelectorAll(b);for(let g=0;g<p.length;g++)w.push(p[g])}return w},[])}insertBefore(b,w){return this.realParentNode.insertBefore(b,w)}moveBefore(b,w){return this.realParentNode.moveBefore(b,w)}get __hyperMorphRoot(){return this.originalNode}}function C(S){let b=new DOMParser,w=S.replace(/<svg(\s[^>]*>|>)([\s\S]*?)<\/svg>/gim,"");if(w.match(/<\/html>/)||w.match(/<\/head>/)||w.match(/<\/body>/)){let d=b.parseFromString(S,"text/html");if(w.match(/<\/html>/))return y.add(d),d;{let p=d.firstChild;return p&&y.add(p),p}}else{let p=b.parseFromString("<body><template>"+S+"</template></body>","text/html").body.querySelector("template").content;return y.add(p),p}}return{normalizeElement:M,normalizeParent:E}})();return{morph:o,defaults:n}})();var zo=dt.morph,Wo=dt.defaults,mt=dt;var _n=null;function Oe(){return _n}function je(e,t){let r={carriedOver:0,discarded:0,listItems:0},n=ht(t,e,r);return pt(t,e,r),{data:n,summary:r}}function ht(e,t,r){if(typeof e=="string")return e.endsWith("[]")?Array.isArray(t)?(r.listItems+=t.length,r.carriedOver+=t.length,t):void 0:t==null?void 0:(r.carriedOver++,t);if(Array.isArray(e)){let[,n]=e;return Array.isArray(t)?(r.listItems+=t.length,t.map(i=>ht(n,i,r))):void 0}if(typeof e=="object"&&e!==null){let n={};for(let[i,o]of Object.entries(e)){let a=ht(o,t?.[i],r);a!==void 0&&(n[i]=a)}return n}}function pt(e,t,r){if(t!=null){if(typeof e=="object"&&e!==null&&!Array.isArray(e)){if(typeof t!="object"||Array.isArray(t))return;let n=new Set(Object.keys(e));for(let i of Object.keys(t))n.has(i)?pt(e[i],t[i],r):r.discarded+=Le(t[i]);return}if(Array.isArray(e)&&Array.isArray(t)){let n=e[1];t.forEach(i=>pt(n,i,r));return}typeof e=="string"&&!e.endsWith("[]")&&typeof t=="object"&&t!==null&&(r.discarded+=Le(t))}}function Le(e){return e==null?0:Array.isArray(e)?e.reduce((t,r)=>t+Le(r),0):typeof e=="object"?Object.values(e).reduce((t,r)=>t+Le(r),0):1}function En(e){return e&&e.nodeType===1&&e.tagName==="SCRIPT"&&e.hasAttribute&&e.hasAttribute("data-rules-name")}function Cn(e){return e?(e.nodeType===9||e.nodeType===11,e):null}var Rn={find(e,t,r={}){let n=Cn(e);if(!n||!n.querySelectorAll)return[];let i=Array.from(n.querySelectorAll(t));r.includeRulesTag||(i=i.filter(a=>!En(a)));let o=[];if(r.skip&&o.push(r.skip),r.templateAttr&&o.push("["+r.templateAttr+"]"),o.length){let a=o.join(", ");i=i.filter(s=>!s.closest||!s.closest(a))}return i},parent(e){return e?e.parentElement:null},children(e){return e?Array.from(e.children):[]},text(e,t){if(t===void 0)return(e.textContent||"").trim();e.textContent=t},attr(e,t,r){if(r===void 0)return e.hasAttribute&&e.hasAttribute(t)?e.getAttribute(t):null;e.setAttribute(t,r)},removeAttr(e,t){e&&e.removeAttribute&&e.removeAttribute(t)},prop(e,t,r){if(r===void 0){let n=e?e[t]:void 0;return n!==void 0?n:null}e[t]=r},clone(e){return e.cloneNode(!0)},insertAt(e,t,r){let n=e.children[r]||null;e.insertBefore(t,n)},remove(e){e&&e.parentNode&&e.parentNode.removeChild(e)},replaceWith(e,t){if(!e||!e.parentNode)throw new Error("dom.replaceWith: node has no parent");let n=e.ownerDocument.createElement("template");n.innerHTML=t;let i=n.content.firstElementChild;if(!i)throw new Error("dom.replaceWith: html did not parse to an element");return e.parentNode.replaceChild(i,e),i},stripIds(e){let t=0;return e.id&&(e.removeAttribute("id"),t++),(e.querySelectorAll?e.querySelectorAll("[id]"):[]).forEach(n=>{n.removeAttribute("id"),t++}),t},sameNode(e,t){return e===t}},U=Rn;var Mn="_hyperHtmlApi",Tn="upgrade-helper",On="parentOrigin";function gt(e=typeof location<"u"?location:null){if(!e)return!1;try{return new URLSearchParams(e.search).get(Mn)===Tn}catch{return!1}}function er(e=typeof location<"u"?location:null){return e?new URLSearchParams(e.search).get(On):null}function yt({win:e,doc:t,parentOrigin:r}={}){if(e=e||(typeof window<"u"?window:null),t=t||(typeof document<"u"?document:null),!e||!t||(r=r||er(e.location),!r))return;let n=()=>Ln({win:e,doc:t,parentOrigin:r});t.readyState==="loading"?t.addEventListener("DOMContentLoaded",n,{once:!0}):n()}function Ln({win:e,doc:t,parentOrigin:r}){let n;try{n=J(U,t.body)}catch(l){return ft(e,r,l)}if(!n)return ft(e,r,new Error("helper-mode: no rules tag in v2 document"));let i=n.rules,o=Nn(t,"hyper-version"),a=!!Oe(),s=l=>{if(l.source!==e.parent||l.origin!==r)return;let c=l.data;if(!(!c||c.type!=="hha:upgrade-data")){e.removeEventListener("message",s);try{let u=jn({doc:t,rules:i,v1Data:c.v1Data});e.parent.postMessage({type:"hha:upgrade-result",html:u.html,summary:u.summary},r)}catch(u){ft(e,r,u)}}};e.addEventListener("message",s),e.parent.postMessage({type:"hha:upgrade-ready",rules:i,version:o,hasTransform:a},r)}function jn({doc:e,rules:t,v1Data:r}){let n=Oe(),i=r,o=!1;n&&(i=n(r),o=!0);let{data:a,summary:s}=je(i,t);Y(U,e.body,t,a);let l=z(U,e.body,t);return{html:`<!DOCTYPE html>
`+e.documentElement.outerHTML,summary:{...s,transformApplied:o,appliedFieldCount:bt(l)}}}function ft(e,t,r){e.parent.postMessage({type:"hha:upgrade-error",name:r?.name||"Error",message:r?.message||String(r)},t)}function Nn(e,t){let r=e.querySelector(`meta[name="${t}"]`);return r?r.getAttribute("content"):null}function bt(e){return e==null?0:Array.isArray(e)?e.reduce((t,r)=>t+bt(r),0):typeof e=="object"?Object.values(e).reduce((t,r)=>t+bt(r),0):1}var F={extract:(e,t,r)=>z(U,e,t,r),apply:(e,t,r,n)=>Y(U,e,t,r,n),findRulesIn:(e,t)=>J(U,e,t),findRules:(e,t)=>ct(U,e,t),bind:(e,t,r)=>Wt(U,e,t,r),parseStrict:lt,parseRelaxed:ye,errors:Me,DOM_PROPERTIES:Ce};typeof window<"u"&&gt(window.location)&&yt({win:window,doc:document});var vt={};nt(vt,{fromString:()=>W,getRuleAtPath:()=>X,getValueAtPath:()=>Dn,setAtPath:()=>kt,toString:()=>$n});function $n(e){return e.map(String).join(".")}function W(e){return e===""?[]:e.split(".").map(t=>/^\d+$/.test(t)?Number(t):t)}function X(e,t){let r=e;for(let n of t){if(r==null)return;if(typeof r=="string"){if(r.endsWith("[]")&&(typeof n=="number"||n==="*")){r=r.slice(0,-2);continue}return}if(Array.isArray(r)){if(typeof n!="number"&&n!=="*")return;r=r[1];continue}if(typeof r=="object"){if(typeof n=="number"||!(n in r))return;r=r[n];continue}return}return r}function Dn(e,t){let r=e;for(let n of t){if(r==null)return;r=r[n]}return r}function kt(e,t,r){if(t.length===0)return r;let[n,...i]=t;if(typeof n=="number"){let o=Array.isArray(e)?[...e]:[];return o[n]=kt(o[n],i,r),o}return{...e&&typeof e=="object"?e:{},[n]:kt((e||{})[n],i,r)}}function ke(e){if(typeof e=="string")return e.endsWith("[]")?[]:"";if(Array.isArray(e))return[];if(typeof e=="object"&&e!==null){let t={};for(let[r,n]of Object.entries(e))t[r]=ke(n);return t}return""}function Ne(e,t,{ignoreActiveValue:r=!0}={}){mt.morph(e,t,{morphStyle:"innerHTML",ignoreActiveValue:r,restoreFocus:!0,formStateSync:"property"})}function qe(e){return e.replace(/([a-z])([A-Z])/g,"$1 $2").replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2").replace(/[-_]/g," ").replace(/\s+/g," ").trim().replace(/^./,t=>t.toUpperCase())}var Pn='<div class="hcms-drag-handle mirk-sortable__grip" aria-hidden="true"><div class="mirk-sortable__dots"><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span><span class="mirk-sortable__dot"></span></div></div>',xt='<svg class="hcms-x" viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true"><path d="M4 4 L12 12 M12 4 L4 12" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="square"></path></svg>',nr={"@scalar":`
  ...
  `},Hn=["@scalar","@object","@scalar-array","@scalar-array-item","@object-array","@object-array-item"];function Fe(e){let t=e.head||e.documentElement;if(t)for(let r of Hn)ar(e,t,r)}function wt(e,t){if(!nr[t])return null;let r=e&&(e.head||e.documentElement);return r?ar(e,r,t):null}var tr={src:"@image",checked:"@checkbox"},Ie={image:"@image",file:"@file",checkbox:"@checkbox",toggle:"@toggle",select:"@select",radio:"@radio",textarea:"@textarea",number:"@number"},Un=new Set([...Object.values(Ie),"@chips","@chips-item"]);function ve(e,t,r){if(typeof e!="string")return"@scalar";let n=e.lastIndexOf("@"),i=Pe(xe(e,n),t,"data-hcms-component");if(i&&Ie[i]){let o=Ie[i],a=Array.isArray(r)&&r.some(s=>s==="*"||typeof s=="number");return o==="@number"&&!rr(e,n,t,a).every(zn)||(o==="@checkbox"||o==="@toggle")&&(n<0||e.slice(n+1)!=="checked")&&!rr(e,n,t,a).every(Wn)?"@scalar":o}if(n>=0){let o=e.slice(n+1);if(tr[o])return tr[o]}return"@scalar"}function ir(e,t){if(typeof e!="string")return null;let r=e.lastIndexOf("@"),n=Pe(xe(e,r),t,"data-hcms-component");return n&&Ie[n]||null}var Bn=/^-?\d+(\.\d+)?([eE][+-]?\d+)?$/;function zn(e){return e==null||e===""?!0:Bn.test(String(e))}function Wn(e){return e==null||e===""||e==="true"||e==="false"}function rr(e,t,r,n){if(!r||!r.querySelectorAll)return[];let i=xe(e,t);if(!i||i===".")return[];let o=null;try{o=r.querySelectorAll(i)}catch{return[]}let a=t>=0?e.slice(t+1):null,s=[];for(let l of o)if(!(l.closest&&l.closest("[cms-template], [data-hcms-shell]"))&&(a?a==="value"&&"value"in l?s.push(l.value):s.push(l.getAttribute?l.getAttribute(a):null):s.push((l.textContent||"").trim()),!n))break;return s}function $e(e,t){if(typeof e!="string"||!e.endsWith("[]")||!t||!t.querySelector)return null;let r=e.slice(0,-2).trim();if(!r)return null;let n=null;try{n=t.querySelector(r)}catch{return null}let i=n&&n.closest?n.closest("[data-hcms-component]"):null;return(i&&i.getAttribute?i.getAttribute("data-hcms-component"):null)==="chips"?{array:"@chips",item:"@chips-item"}:null}function ie(e,t,r){let n=e.join("."),i=e.map(o=>typeof o=="number"?"*":o).join(".");return n&&P(r,n)||i&&i!==n&&P(r,i)||P(r,t)}function De(e,t,r){let n=$e(e,r);if(!n)return null;let i=ie(t,n.array,r);return i&&i.getAttribute("data-hcms-tpl")===n.array?n:null}function or(e,t){if(typeof e!="string")return null;let r=e.lastIndexOf("@"),n=Pe(xe(e,r),t,"data-hcms-options");if(n==null)return null;let i=n.trim().split(/\s+/).filter(Boolean);return i.length?i:null}function sr(e,t){if(typeof e!="string")return null;let r=e.lastIndexOf("@");return Pe(xe(e,r),t,"data-hcms-crop")}function xe(e,t){return t>=0?e.slice(0,t):e}function Pe(e,t,r){if(!t||!t.querySelector||!e||e===".")return null;let n=null;try{n=t.querySelector(e)}catch{return null}return n&&n.getAttribute?n.getAttribute(r):null}function He(e,t){if(!e||t==null)return;r(t);function r(n){let i=Z(n);if(i==="scalar"){let o=ve(n,e);Un.has(o)&&wt(e,o);return}if(i==="scalar-array"){let o=$e(n,e);o&&(wt(e,o.array),wt(e,o.item));return}if(i==="object"){for(let o of Object.values(n))r(o);return}if(i==="object-array"){let o=n[1];if(o&&typeof o=="object"&&!Array.isArray(o))for(let a of Object.values(o))r(a);else r(o)}}}function ar(e,t,r){let n=P(e,r);if(n)return n;let i=e.createElement("template");return i.setAttribute("data-hcms-tpl",r),i.setAttribute("save-remove",""),i.innerHTML=nr[r].trim(),t.appendChild(i),i}function P(e,t){return!e||!e.querySelector?null:e.querySelector(`template[data-hcms-tpl="${Vn(t)}"]`)}function Vn(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^a-zA-Z0-9_\-.*]/g,t=>"\\"+t)}function Z(e){return typeof e=="string"?e.endsWith("[]")?"scalar-array":"scalar":Array.isArray(e)?"object-array":typeof e=="object"&&e!==null?"object":"scalar"}function we(e){return e?!!(e.content||e).querySelector("[data-hcms-field]"):!1}var lr={IMG:"src",A:"href"};function Ue(e){if(!e)return"value";let t=(e.tagName||"").toUpperCase();return t==="INPUT"?(e.getAttribute("type")||"text").toLowerCase()==="checkbox"?"checked":"value":t==="TEXTAREA"||t==="SELECT"?"value":lr[t]?lr[t]:null}function cr(e,t){let r=(e.tagName||"").toUpperCase(),n=(e.getAttribute&&e.getAttribute("type")||"").toLowerCase(),i=Ue(e),a=`${dr(r,n)}[data-hcms-field="${oe(t)}"]`;return r==="INPUT"&&n==="radio"?`${a}:checked@value`:i?`${a}@${i}`:a}function Kn(e){let t=(e.tagName||"").toUpperCase(),r=(e.getAttribute&&e.getAttribute("type")||"").toLowerCase(),n=Ue(e),o=`${dr(t,r)}[data-hcms-field]`;return t==="INPUT"&&r==="radio"?`${o}:checked@value`:n?`${o}@${n}`:o}function dr(e,t){return e==="INPUT"?t?`input[type="${t}"]`:"input":e==="TEXTAREA"?"textarea":e==="SELECT"?"select":e==="IMG"?"img":e==="A"?"a":':not([data-hcms-shape="scalar"]):not([data-hcms-shape="object"]):not([data-hcms-shape="object-array"]):not([data-hcms-shape="scalar-array"])'}function oe(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^a-zA-Z0-9_\-.*]/g,t=>"\\"+t)}var ur=new Set(["__proto__","constructor","prototype"]);function Be(e,t){return r(e,[]);function r(c,u){let m=Z(c);if(m==="scalar")return n(c,u);if(m==="scalar-array")return i(c,u);if(m==="object-array")return o(c,u);if(m==="object"){let h=Object.create(null);for(let[k,x]of Object.entries(c)){if(ur.has(k))throw new Error(`hypercms: rule key "${k}" is forbidden at "${u.join(".")||"<root>"}"`);h[k]=r(x,[...u,k])}return h}return null}function n(c,u){let m=u.length?u[u.length-1]:null,h=typeof m=="string"?m:"__value",k=l(u,h);if(k)return cr(k,h);let x=s(ve(c,t,u),h);return x?cr(x,h):`input[data-hcms-field="${oe(h)}"]@value`}function i(c,u){let m=De(c,u,t),h=m&&s(m.item,null)||s("@scalar-array-item",null),k=h?Kn(h):"input[data-hcms-field]@value";return[a(u,"[data-hcms-array-item]"),k]}function o(c,u){let[,m]=c,h=[...u,"*"],k=a(u,"[data-hcms-card]");if(m&&typeof m=="object"&&!Array.isArray(m)){let x=Object.create(null);for(let[T,y]of Object.entries(m)){if(ur.has(T))throw new Error(`hypercms: rule key "${T}" is forbidden at "${h.join(".")}"`);x[T]=r(y,[...h,T])}return[k,x]}return[k,r(m,[...h,0])]}function a(c,u){let m=c.length?c[c.length-1]:"",h=c.some(T=>T==="*"),k=c.join(".");return`${h?`[data-hcms-field="${oe(m)}"]`:`[data-hcms-path="${oe(k)}"]`} > .hcms-array-items > ${u}`}function s(c,u){if(!t)return null;let m=P(t,c);if(!m)return null;let h=m.content||m;if(u){let k=h.querySelector(`[data-hcms-field="${oe(u)}"]`);if(k)return k}return h.querySelector("[data-hcms-field]")}function l(c,u){if(!t)return null;let m=c.map(x=>typeof x=="number"?"*":x).join("."),k=[c.join("."),m];for(let x=c.length-1;x>=0;x--){let T=c.slice(0,x).map(y=>typeof y=="number"?"*":y);T.push("*"),k.push(T.join("."))}for(let x of k){if(!x)continue;let T=P(t,x);if(!T||!we(T))continue;let y=T.content||T,M=y.querySelector(`[data-hcms-field="${oe(u)}"]`)||y.querySelector("[data-hcms-field]");if(M)return M}return null}}function At(e){if(!e)return"";let t=String(e).split(/[?#]/)[0],r=t.split("/").pop()||t;try{return decodeURIComponent(r)}catch{return r}}function ze({pageRules:e,formRules:t,data:r,doc:n}){let i=n.createDocumentFragment(),o=St(e,[],r,n);return o&&i.appendChild(o),i}function hr({shape:e,itemShape:t,pathArr:r,data:n,doc:i,itemKey:o}){if(e==="object-array-item")return fr(t,r,n,i);if(e==="scalar-array-item")return br(r,n,i,o||null);throw new Error(`hypercms: buildItem called with unknown shape "${e}"`)}function St(e,t,r,n){let i=Z(e);return i==="scalar"?Gn(e,t,r,n):i==="object"?Zn(e,t,r,n):i==="object-array"?Qn(e,t,r,n):i==="scalar-array"?ei(e,t,r,n):null}function Gn(e,t,r,n){let i=ve(e,n,t),o=ie(t,i,n);if(!o)throw new Error(`hypercms: missing template for scalar at "${t.join(".")}"`);let a=ir(e,n);a==="@number"&&i==="@scalar"&&console.info(`[hypercms] field "${t.join(".")}" declares component "@number" but its value isn't a plain number; rendering a text input so the value is preserved`),(a==="@checkbox"||a==="@toggle")&&i==="@scalar"&&console.info(`[hypercms] field "${t.join(".")}" declares component "${a}" but its value isn't true/false; rendering a text input so the value is preserved`),pr(o,a===i?a:null,t);let s=se(o,n);ae(s,t);let l=o.getAttribute?.("data-hcms-tpl");if((i==="@select"||i==="@radio")&&l===i&&Yn(s,e,t,r,n,i),i==="@image"&&l==="@image"){let c=sr(e,n);c!=null&&!s.hasAttribute("data-hcms-crop")&&s.setAttribute("data-hcms-crop",c)}return ti(s,V(t)),We(s,V(t)),Ve(s,V(t)),xr(s,r),i==="@file"&&Xn(s),s}function pr(e,t,r){if(!t)return;let n=e.getAttribute?.("data-hcms-tpl");n&&n!==t&&console.info(`[hypercms] field "${r.join(".")}" declares component "${t}" but custom template "${n}" wins`)}function Yn(e,t,r,n,i,o){let a=or(t,i),s=a?[...a]:[],l=n==null?"":String(n);if(l!==""&&!s.includes(l)&&s.unshift(l),!a&&(Jn(e,"data-hcms-options required (space-separated values)"),s.length===0)){e.querySelector(".mirk-radio")?.remove();return}if(o==="@select"){let m=e.querySelector("select[data-hcms-field]");if(!m)return;for(let h of s){let k=i.createElement("option");k.value=h,k.textContent=qe(h),m.appendChild(k)}return}let c=e.querySelector(".mirk-radio");if(!c||!c.parentNode)return;let u=_t(r.join("."));for(let m of s){let h=c.cloneNode(!0),k=h.querySelector('input[type="radio"]');k&&(k.value=m,k.name=u);let x=h.querySelector(".mirk-radio__label");x&&(x.textContent=qe(m)),c.parentNode.insertBefore(h,c)}c.remove()}function _t(e){return"hcms-"+String(e).replace(/[^A-Za-z0-9_-]/g,"-")}function Jn(e,t){let r=e.querySelector?e.querySelector(".hcms-error"):null;r&&(r.textContent=t,r.hidden=!1)}function Xn(e){let t=e.querySelector?e.querySelector("a.mirk-file__name[data-hcms-field]"):null;t&&(t.textContent=At(t.getAttribute("href")))}function Zn(e,t,r,n){let i=ie(t,"@object",n);if(!i)throw new Error(`hypercms: missing template for object at "${t.join(".")}"`);let o=se(i,n);if(ae(o,t),We(o,V(t)),Ve(o,V(t)),we(i))return Ar(o,e,t),wr(o,e,r),o;let a=Ke(o,".hcms-object-fields",i,t);for(let[s,l]of Object.entries(e)){let c=r==null?null:r[s],u=St(l,[...t,s],c,n);u&&a.appendChild(u)}return o}function Qn(e,t,r,n){let i=ie(t,"@object-array",n);if(!i)throw new Error(`hypercms: missing template for object-array at "${t.join(".")}"`);let o=se(i,n);ae(o,t),We(o,V(t)),Ve(o,V(t)),yr(o,i),vr(o,i,t);let a=Ke(o,".hcms-array-items",i,t),[,s]=e;return(Array.isArray(r)?r:[]).forEach((c,u)=>{let m=fr(s,[...t,u],c,n);m&&a.appendChild(m)}),kr(o),o}function fr(e,t,r,n){let i=gr(t,"object-array-item",n);if(!i)throw new Error(`hypercms: missing item template for "${t.join(".")}"`);let o=se(i,n);if(o.setAttribute("data-hcms-card",""),o.classList.contains("hcms-card")||o.classList.add("hcms-card"),ae(o,t),we(i))return e&&typeof e=="object"&&!Array.isArray(e)&&(Ar(o,e,t),wr(o,e,r)),o;let a=Ke(o,".hcms-card-fields",i,t);if(e&&typeof e=="object"&&!Array.isArray(e))for(let[s,l]of Object.entries(e)){let c=r==null?null:r[s],u=St(l,[...t,s],c,n);u&&a.appendChild(u)}return o}function ei(e,t,r,n){let i=$e(e,n),o=De(e,t,n),a=i?i.array:"@scalar-array",s=ie(t,a,n);if(!s)throw new Error(`hypercms: missing template for scalar-array at "${t.join(".")}"`);pr(s,i?i.array:null,t);let l=se(s,n);ae(l,t),We(l,V(t)),Ve(l,V(t)),yr(l,s),vr(l,s,t),o&&l.setAttribute("data-hcms-item-tpl",o.item);let c=Ke(l,".hcms-array-items",s,t);return(Array.isArray(r)?r:[]).forEach((m,h)=>{let k=br([...t,h],m,n,o?o.item:null);k&&c.appendChild(k)}),kr(l),l}function br(e,t,r,n){let i=gr(e,"scalar-array-item",r,n);if(!i)throw new Error(`hypercms: missing item template for "${e.join(".")}"`);let o=se(i,r);return o.setAttribute("data-hcms-array-item",""),o.classList.contains("hcms-array-item")||o.classList.add("hcms-array-item"),ae(o,e),xr(o,t),o}function gr(e,t,r,n){let i=e.map(o=>typeof o=="number"?"*":o).join(".");return P(r,i)||n&&P(r,n)||P(r,"@"+t)}function se(e,t){let r=e.content||e,n=t.createElement("div");return n.appendChild(r.cloneNode(!0)),n.firstElementChild||n}function ae(e,t){e.setAttribute("data-hcms-path",t.join("."))}function ti(e,t){let r=t==null?"":String(t);if(e.matches&&e.matches("[data-hcms-field]")){e.getAttribute("data-hcms-field")||e.setAttribute("data-hcms-field",r);return}(e.querySelectorAll?e.querySelectorAll("[data-hcms-field]"):[]).forEach(i=>{i.getAttribute("data-hcms-field")||i.setAttribute("data-hcms-field",r)})}function We(e,t){t==null||t===""||!e.setAttribute||e.hasAttribute?.("data-hcms-field")||e.setAttribute("data-hcms-field",String(t))}function Ve(e,t){if(t==null||t==="")return;(e.querySelectorAll?e.querySelectorAll("[data-hcms-label]"):[]).forEach(n=>{(n.textContent||"").trim()===""&&(n.textContent=qe(String(t)))})}function yr(e,t){["data-hcms-no-add","data-hcms-no-remove","data-hcms-no-reorder"].forEach(r=>{t.hasAttribute(r)&&e.setAttribute(r,"")}),["data-hcms-min-items","data-hcms-max-items"].forEach(r=>{t.hasAttribute(r)&&e.setAttribute(r,t.getAttribute(r))})}function kr(e){let t=e.querySelector?e.querySelector(".hcms-array-items"):null;if(!t)return;let r=Array.from(t.querySelectorAll(":scope > [data-hcms-card], :scope > [data-hcms-array-item]")),n=r.length,i=mr(e,"data-hcms-max-items"),o=mr(e,"data-hcms-min-items"),a=e.hasAttribute("data-hcms-no-add"),s=e.hasAttribute("data-hcms-no-remove"),l=e.hasAttribute("data-hcms-no-reorder"),c=e.querySelector('[data-hcms-action="add"]');c&&(c.hidden=a||i!=null&&n>=i),r.forEach((u,m)=>{let h=u.querySelector('[data-hcms-action="remove"]');h&&(h.hidden=s||o!=null&&n<=o);let k=u.querySelector('[data-hcms-action="move-up"]');k&&(k.hidden=l||m===0);let x=u.querySelector('[data-hcms-action="move-down"]');x&&(x.hidden=l||m===n-1)})}function mr(e,t){if(!e||!e.hasAttribute(t))return null;let r=parseInt(e.getAttribute(t),10);return Number.isFinite(r)?r:null}function vr(e,t,r){if(e.hasAttribute("data-hcms-no-reorder")||t.hasAttribute("data-hcms-no-reorder"))return;let n=e.querySelector(".hcms-array-items");if(!n)return;let i="hcms-"+r.join(".");n.setAttribute("sortable",i),n.setAttribute("onsorted","hypercmsCommit && hypercmsCommit()")}function V(e){return e.length?e[e.length-1]:null}function xr(e,t){let r=ri(e);if(r.length!==0)for(let n of r)Sr(n,t)}function ri(e){if(!e)return[];let t=[];return e.matches?.("[data-hcms-field]")&&ni(e)&&t.push(e),(e.querySelectorAll?e.querySelectorAll("input[data-hcms-field], textarea[data-hcms-field], select[data-hcms-field], img[data-hcms-field], a[data-hcms-field], [contenteditable][data-hcms-field]"):[]).forEach(n=>t.push(n)),t}function ni(e){let t=(e.tagName||"").toUpperCase();return!!(t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||t==="IMG"||t==="A"||e.hasAttribute?.("contenteditable"))}function wr(e,t,r){(e.querySelectorAll?e.querySelectorAll("[data-hcms-field]"):[]).forEach(i=>{let o=i.getAttribute("data-hcms-field");if(!o)return;if(!t||typeof t!="object"||!(o in t)){console.warn(`[hypercms] inline template field "${o}" is not in the rule shape; ignoring`);return}let a=r==null?null:r[o];Sr(i,a)})}function Ar(e,t,r){if(!e.querySelectorAll)return;e.querySelectorAll("[data-hcms-field]").forEach(i=>{let o=i.getAttribute("data-hcms-field");if(!o||t&&typeof t=="object"&&!(o in t))return;let a=[...r,o].join(".");i.setAttribute("data-hcms-path",a)})}function Ke(e,t,r,n){if(!e.querySelector)return e;let i=e.querySelector(t);if(i)return i;let o=r?.getAttribute?.("data-hcms-tpl")||n.join(".");throw new Error(`hypercms: template "${o}" is in slotted mode but has no ${t} element`)}function Sr(e,t){let r=Ue(e),n=(e.tagName||"").toUpperCase(),i=(e.getAttribute("type")||"").toLowerCase();if(n==="INPUT"&&i==="radio"){e.checked=e.value!=null&&String(e.value)===String(t??"");return}if(r==="checked"){e.checked=t===!0||t==="true";return}if(r){e[r]=t==null?"":String(t);return}e.textContent=t==null?"":String(t)}var _r={skip:"[data-hcms-shell]",templateAttr:"cms-template"};function Er(e,t,r,n={}){let{observerHandle:i,shellRoot:o,structural:a,structuralPath:s}=n;i?.pause?.();try{if(!a)try{return F.apply(e,t,r,_r),{ok:!0}}catch(m){return{ok:!1,error:m}}let l=ii(e,t,s),c=l?si(l):null,u=l?null:li(e,o);try{return F.apply(e,t,r,_r),{ok:!0}}catch(m){return c?ai(l,c):u&&ci(e,o,u),{ok:!1,error:m}}}finally{i?.resume?.()}}function ii(e,t,r){if(!r||!e)return null;let n=W(r),i=[],o=t;for(let a of n){if(typeof o=="string"||o==null||Array.isArray(o))break;if(typeof o=="object"&&a in o){if(i.push(a),o=o[a],Array.isArray(o)||typeof o=="string"&&o.endsWith("[]"))break}else return null}return!Array.isArray(o)&&!(typeof o=="string"&&o.endsWith("[]"))?null:oi(e,t,i)}function oi(e,t,r){if(r.length===0)return null;let n=e,i=t;for(let o=0;o<r.length;o++){let a=r[o];if(!i||typeof i!="object"||Array.isArray(i))return null;let s=i[a];if(s==null)return null;if(o===r.length-1){if(Array.isArray(s)){let[l]=s;return n.querySelector?.(l)?.parentElement||null}if(typeof s=="string"&&s.endsWith("[]")){let l=s.slice(0,-2);return n.querySelector?.(l)?.parentElement||null}return null}i=s}return null}function si(e){let t=[];for(let r of Array.from(e.childNodes))t.push(r.cloneNode(!0));return t}function ai(e,t){for(;e.firstChild;)e.removeChild(e.firstChild);for(let r of t)e.appendChild(r)}function li(e,t){let r=[];for(let n of Array.from(e.childNodes))n===t||t&&n.contains?.(t)||r.push(n.cloneNode(!0));return r}function ci(e,t,r){for(let i of Array.from(e.childNodes))i===t||t&&i.contains?.(t)||e.removeChild(i);let n=ui(e,t);for(let i of r)e.insertBefore(i,n||null)}function ui(e,t){if(!t)return null;for(let r of Array.from(e.childNodes))if(r===t||r.contains?.(t))return r;return null}var Et=new WeakSet;function ce(e,t){let r=typeof window<"u"&&window.hyperclay&&window.hyperclay.undo||null;if(!r)return t();r.pause();try{let n=t();return n&&n.ok?r.commitCaptured(e):r.discardCaptured(),n}finally{r.resume()}}function Je(e){let t=typeof window<"u"&&window.hyperclay&&window.hyperclay.undo||null;if(!t)return e();t.pause();try{return e()}finally{t.discardCaptured(),t.resume()}}function Mr(e){let{formRoot:t}=e;if(!t||Et.has(t))return;Et.add(t);let r=a=>{let s=a.target;!s||!s.closest||s.closest("[data-hcms-form-root]")&&s.matches("input, textarea, select")&&(s.matches('input[type="file"]')||!s.closest("[data-hcms-field]")&&!s.hasAttribute?.("data-hcms-field")||Cr(s,e))},n=a=>{let s=a.target;if(!(!s||!s.closest)&&s.closest("[data-hcms-form-root]")){if(s.matches('input[type="file"][data-hcms-upload]')){gi(s,e);return}s.matches('input[type="checkbox"], input[type="radio"], select')&&Cr(s,e)}},i=a=>{let s=a.target;if(!s||!s.closest)return;let l=s.closest("[data-hcms-action]");if(!l)return;let c=l.getAttribute("data-hcms-action");if(c==="add"||c==="remove"||c==="move-up"||c==="move-down"||c==="clear-upload"){if(!l.closest("[data-hcms-form-root]"))return}else if(c==="close"&&!l.closest("[data-hcms-shell]"))return;if(c==="add"){let u=l.closest("[data-hcms-path]");if(!u)return;let m=u.getAttribute("data-hcms-path");Ct(m,e)}else if(c==="remove"){let u=l.closest("[data-hcms-card], [data-hcms-array-item]");if(!u)return;Ai(u,e)}else if(c==="move-up"||c==="move-down"){let u=l.closest("[data-hcms-card], [data-hcms-array-item]");if(!u)return;xi(u,c==="move-up"?-1:1,e)}else c==="clear-upload"?yi(l,e):c==="close"&&e.onCloseRequested?.()},o=t.ownerDocument;o.addEventListener("input",r,!0),o.addEventListener("change",n,!0),o.addEventListener("click",i,!0),e.detachEvents=()=>{o.removeEventListener("input",r,!0),o.removeEventListener("change",n,!0),o.removeEventListener("click",i,!0),Et.delete(t)}}var di=new Set(["value","checked"]);function mi(e,t){if(!t)return null;let r=W(t);if(r.some(l=>typeof l=="number"||l==="*"))return null;let n=X(e.pageRules,r);if(typeof n!="string")return null;let i=n.lastIndexOf("@");if(i===-1)return null;let o=n.slice(i+1);if(!di.has(o))return null;let a=n.slice(0,i),s=a?e.pageRoot.querySelector(a):e.pageRoot;return s?{el:s,prop:o,oldValue:s[o]}:null}function Cr(e,t){let n=(e.closest("[data-hcms-field]")||e).closest("[data-hcms-path]")?.getAttribute("data-hcms-path")||"",i=mi(t,n);if(B($(t),{path:n,structural:!1},t),i){let o=typeof window<"u"&&window.hyperclay&&window.hyperclay.undo||null;o&&typeof o.recordValue=="function"&&o.recordValue(i.el,{prop:i.prop,oldValue:i.oldValue,newValue:i.el[i.prop]})}}var hi={type:"image/webp",quality:.85,maxWidth:2048,maxHeight:2048};async function pi(e,t){let r=t&&t.getAttribute?t.getAttribute("data-hcms-crop"):null;if(r==null)return{file:e};let n=typeof window<"u"&&window.hyperclay&&window.hyperclay.quickcrop||null;if(typeof n!="function")return{file:e};try{let i=await n(e,{aspect:fi(r),...hi});return i===null?null:{file:bi(i.blob,e.name),dataURL:i.dataURL}}catch(i){return Ae(t,i&&i.message||"Crop failed"),null}}function fi(e){let t=String(e??"").trim().toLowerCase();if(t===""||t==="free")return null;let r=t.match(/^(\d+(?:\.\d+)?)\s*[:/]\s*(\d+(?:\.\d+)?)$/);if(!r)return null;let n=parseFloat(r[1]),i=parseFloat(r[2]);return!n||!i?null:n/i}function bi(e,t){let r=e.type==="image/webp"?".webp":e.type==="image/jpeg"?".jpg":".png",n=String(t||"image").replace(/\.[^.]+$/,"");try{return new File([e],n+r,{type:e.type})}catch{return e}}async function gi(e,t){let r=e.files&&e.files[0];if(!r)return;let n=e.closest("[data-hcms-path]");if(!n)return;let i=n.getAttribute("data-hcms-path")||"";Ae(n,null);let o=await pi(r,n);if(!o||t.closed){Q(e);return}let a=o.file,s=o.dataURL||null,l=typeof window<"u"&&window.hyperclay&&window.hyperclay.uploadFileBasic||null,c=null;if(typeof l=="function")try{let u=await l(a);c=u&&u.uploads&&u.uploads[0]&&u.uploads[0].url}catch(u){if(t.closed){Q(e);return}Ae(n,u&&u.message||"Upload failed"),t.dispatch?.("hcms:error",{error:u,path:i}),Q(e);return}if(t.closed){Q(e);return}if(c||(c=s||vi(a)),!c){Q(e);return}Ae(n,null),Tr(n,c,a.name),B($(t),{path:i,structural:!1},t),Q(e)}function yi(e,t){let r=e.closest("[data-hcms-path]");if(!r)return;let n=r.getAttribute("data-hcms-path")||"";Tr(r,"","");let i=r.querySelector('input[type="file"][data-hcms-upload]');i&&Q(i),Ae(r,null),B($(t),{path:n,structural:!1},t)}function ki(e){return e.querySelector?e.querySelector("img[data-hcms-field], a[data-hcms-field]"):null}function Tr(e,t,r){let n=ki(e);if(!n)return;let i=(n.tagName||"").toUpperCase();i==="IMG"?n.src=t||"":i==="A"&&(n.href=t||"",n.textContent=t?r||At(t):"")}function Q(e){try{e.value=""}catch{}}function vi(e){let t=typeof URL<"u"&&URL.createObjectURL?URL:null;if(!t)return"";try{return t.createObjectURL(e)}catch{return""}}function Ae(e,t){let r=e.querySelector?e.querySelector(":scope > .hcms-error"):null;r&&(t?(r.textContent=t,r.hidden=!1):(r.textContent="",r.hidden=!0))}function Ct(e,t){let{formRoot:r,pageRules:n}=t,i=r.querySelector(`[data-hcms-path="${Ti(e)}"]`);if(!i)throw new Error(`hypercms: no element at path "${e}"`);let o=i.querySelector(".hcms-array-items");if(!o)throw new Error(`hypercms: array container missing .hcms-array-items at "${e}"`);let a=W(e),s=Ci(n,a),l=Array.isArray(s),c=typeof s=="string"&&s.endsWith("[]");if(!l&&!c)throw new Error(`hypercms: path "${e}" is not an array`);let u=Ye(i,"data-hcms-max-items"),m=o.querySelectorAll(":scope > [data-hcms-card], :scope > [data-hcms-array-item]");if(i.hasAttribute("data-hcms-no-add")||u!=null&&m.length>=u)return;let h=m.length,k=l?s[1]:s.replace(/\[\]$/,""),x=ke(l?k:"string"),T=hr({shape:l?"object-array-item":"scalar-array-item",itemShape:k,pathArr:[...a,h],data:x,doc:t.doc,itemKey:i.getAttribute("data-hcms-item-tpl")||null});return o.appendChild(T),Mt(i),ce(`Add ${e}`,()=>B($(t),{path:e,structural:!0},t))}function xi(e,t,r){let n=e.closest('[data-hcms-shape="object-array"], [data-hcms-shape="scalar-array"]');if(!n||n.hasAttribute("data-hcms-no-reorder"))return;let i=n.querySelector(".hcms-array-items");if(!i)return;let o=Array.from(i.querySelectorAll(":scope > [data-hcms-card], :scope > [data-hcms-array-item]")),a=o.indexOf(e);if(a<0)return;let s=a+t;if(s<0||s>=o.length)return;let l=e.querySelector(`[data-hcms-action="${t<0?"move-up":"move-down"}"]`);return t<0?i.insertBefore(e,o[s]):i.insertBefore(e,o[s].nextSibling),Ot(i),Mt(n),l&&typeof l.focus=="function"&&e.querySelector(`[data-hcms-action="${t<0?"move-up":"move-down"}"]`)?.focus?.(),ce(`Reorder ${n.getAttribute("data-hcms-path")||""}`,()=>B($(r),{path:n.getAttribute("data-hcms-path")||"",structural:!0},r))}var Ge="Delete this item?";function wi(e,t){let r=e&&e.getAttribute("data-hcms-confirm-remove");if(r!=null)return/^(off|false|no|0)$/i.test(r.trim())?null:r||Ge;let n=t&&t.confirmRemove;return n===!1?null:typeof n=="string"?n||Ge:n===!0||e&&e.getAttribute("data-hcms-shape")==="object-array"?Ge:null}function Ai(e,t){let r=e.closest('[data-hcms-shape="object-array"], [data-hcms-shape="scalar-array"]'),n=wi(r,t);if(n==null)return le(e,t);let i=typeof window<"u"&&(window.hyperclay?.consent||window.consent);typeof i=="function"?Promise.resolve(i(n)).then(()=>le(e,t),()=>{}):typeof window<"u"&&typeof window.confirm=="function"?window.confirm(n)&&le(e,t):le(e,t)}function le(e,t){let r=e.getAttribute("data-hcms-path")||"",n=e.parentElement,i=e.closest('[data-hcms-shape="object-array"], [data-hcms-shape="scalar-array"]');if(!i?.hasAttribute("data-hcms-no-remove")){if(i){let o=Ye(i,"data-hcms-min-items"),a=i.querySelector(".hcms-array-items"),s=a?a.querySelectorAll(":scope > [data-hcms-card], :scope > [data-hcms-array-item]").length:0;if(o!=null&&s<=o)return}return e.remove(),n&&Ot(n),i&&Mt(i),ce(`Remove ${r}`,()=>B($(t),{path:r,structural:!0},t))}}function B(e,t,r){let n=Se(e);if(n===r.lastFingerprint)return{ok:!0,skipped:!0};let i=Er(r.pageRoot,r.pageRules,e,{observerHandle:r.observerHandle,shellRoot:r.shellRoot,structural:!!t.structural,structuralPath:t.path||null});return i.ok?(r.lastFingerprint=n,r.lastData=e,Rr(r,null),r.dispatch?.("hcms:change",{data:e,path:t.path,structural:!!t.structural}),r.onChange?.(e,t)):(Rr(r,Ei(i.error,t.path)),r.dispatch?.("hcms:error",{error:i.error,attemptedData:e}),r.onError?.(i.error)),i}function $(e){let t=F.extract(e.formRoot,e.formRules);return K(t,e.formRules)}function K(e,t){if(t==null||e==null)return e;if(typeof t=="string")return t.endsWith("@checked")?e===!0||e==="true":e;if(Array.isArray(t)){if(!Array.isArray(e))return e;let[,r]=t;return e.map(n=>K(n,r))}if(typeof t=="object"){if(typeof e!="object"||Array.isArray(e))return e;let r={};for(let[n,i]of Object.entries(t))r[n]=K(e[n],i);return r}return e}function Rr(e,t){e.lastErrors=t&&t.length?t:null,Rt(e)}function Rt(e){if(Si(e),e.errorEl&&(e.errorEl.textContent="",e.errorEl.hidden=!0),!e.lastErrors)return;let t=[];for(let{message:r,path:n}of e.lastErrors){if(n!=null&&n!==""){let i=_i(e.formRoot,n);if(i){i.textContent=i.textContent?`${i.textContent}
${r}`:r,i.hidden=!1;continue}}t.push(r)}t.length&&e.errorEl&&(e.errorEl.textContent=t.join(`
`),e.errorEl.hidden=!1)}function Si(e){if(e.formRoot)for(let t of e.formRoot.querySelectorAll(".hcms-error"))t.textContent="",t.hidden=!0}function _i(e,t){if(!e)return null;let r=t.split(".");for(;r.length>0;){let n=r.join("."),i=typeof CSS<"u"&&CSS.escape?CSS.escape(n):n.replace(/[^a-zA-Z0-9_\-.*]/g,a=>"\\"+a),o=e.querySelector(`[data-hcms-path="${i}"]`);if(o){for(let a of o.children)if(a.classList&&a.classList.contains("hcms-error"))return a}r.pop()}return null}function Ei(e,t){return e?e.name==="EmptyListInsert"?[{message:"Add a seed item in HTML first.",path:t}]:e.name==="ShapeMismatch"&&Array.isArray(e.mismatches)&&e.mismatches.length?e.mismatches.map(r=>({message:`Shape mismatch: expected ${r.expected}, got ${r.got}`,path:r.path})):[{message:e.message||String(e),path:t}]:[{message:"unknown error",path:t}]}function Ci(e,t){let r=e;for(let n of t){if(r==null||typeof r=="string")return;if(Array.isArray(r)){if(typeof n!="number"&&n!=="*")return;r=r[1];continue}if(typeof r=="object"){if(typeof n=="number"||!(n in r))return;r=r[n];continue}return}return r}function Ye(e,t){if(!e||!e.hasAttribute(t))return null;let r=parseInt(e.getAttribute(t),10);return Number.isFinite(r)?r:null}function Mt(e){if(!e)return;let t=e.querySelector(".hcms-array-items");if(!t)return;let r=Array.from(t.querySelectorAll(":scope > [data-hcms-card], :scope > [data-hcms-array-item]")),n=r.length,i=Ye(e,"data-hcms-max-items"),o=Ye(e,"data-hcms-min-items"),a=e.hasAttribute("data-hcms-no-add"),s=e.hasAttribute("data-hcms-no-remove"),l=e.hasAttribute("data-hcms-no-reorder"),c=e.querySelector(':scope > .hcms-add, :scope > * > .hcms-add, :scope > [data-hcms-action="add"]');c&&(c.hidden=a||i!=null&&n>=i),r.forEach((u,m)=>{let h=u.querySelector('[data-hcms-action="remove"]');h&&(h.hidden=s||o!=null&&n<=o);let k=u.querySelector('[data-hcms-action="move-up"]');k&&(k.hidden=l||m===0);let x=u.querySelector('[data-hcms-action="move-down"]');x&&(x.hidden=l||m===n-1)})}function Tt(e){!e||!e.querySelectorAll||e.querySelectorAll(".hcms-array-items").forEach(t=>Ot(t))}function Ot(e){let t=e.querySelectorAll?Array.from(e.querySelectorAll('input[type="radio"][data-hcms-field]'),n=>[n,n.checked]):[],r=0;for(let n of e.children){if(!n.matches?.("[data-hcms-card], [data-hcms-array-item]"))continue;let i=n.getAttribute("data-hcms-path");if(!i)continue;let o=i.split(".");o[o.length-1]=String(r);let a=o.join(".");a!==i&&Ri(n,i,a),r++}for(let[n,i]of t)n.checked!==i&&(n.checked=i)}function Ri(e,t,r){let n=e.querySelectorAll("[data-hcms-path]");e.setAttribute("data-hcms-path",r);for(let i of n){let o=i.getAttribute("data-hcms-path");o===t?i.setAttribute("data-hcms-path",r):o&&o.startsWith(t+".")&&i.setAttribute("data-hcms-path",r+o.slice(t.length))}Mi(e)}function Mi(e){for(let t of e.querySelectorAll('input[type="radio"][data-hcms-field]')){if(!t.name||!t.name.startsWith("hcms-"))continue;let r=t.closest("[data-hcms-path]");r&&(t.name=_t(r.getAttribute("data-hcms-path")))}}function Se(e){return JSON.stringify(e,(t,r)=>{if(r&&typeof r=="object"&&!Array.isArray(r)){let n=Object.create(null);for(let i of Object.keys(r).sort())n[i]=r[i];return n}return r})}function Ti(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^a-zA-Z0-9_\-.*]/g,t=>"\\"+t)}var Fi={},Xe="hcms-shell-styles",Oi="hcms-bundled-styles-installed",Li='a[href], area[href], button:not([disabled]), input:not([disabled]):not([type="hidden"]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',ue=new WeakSet,Lt="";function Lr(e){Lt=e}var ji=0;function Or(e){return String(e).replace(/[&<>"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[t])}function jr({mountTo:e,side:t="right",overlay:r=!1,showSaveButton:n=!1,title:i="Page content",eyebrow:o="Edit",theme:a=null,doc:s}){Nr(s);let l=`hcms-shell-title-${++ji}`,c=s.createElement("div");c.setAttribute("data-hcms-shell",""),c.setAttribute("save-remove",""),c.setAttribute("save-ignore",""),c.setAttribute("tabindex","-1"),c.setAttribute("role","dialog"),c.setAttribute("aria-modal","true"),c.setAttribute("aria-labelledby",l);let u=a==="dark"?" dark":a==="light"?" light":"";c.className="hcms-shell pixel-quiet hcms-side-"+t+(r?" hcms-overlay":"")+u;let m=Or(i),h=Or(o);c.innerHTML=`
  ...
  `,(e||s.body).appendChild(c);let x=s.body;x.classList.add("hcms-open"),r&&x.classList.add("hcms-overlay"),t==="left"&&x.classList.add("hcms-side-left");let T=qi(c,s),y=Ii(c);return{root:c,formRoot:c.querySelector("[data-hcms-form-root]"),errorEl:c.querySelector(".hcms-shell-error"),saveButton:c.querySelector(".hcms-shell-save"),destroy(){T.detach(),y.detach(),c.remove(),x.classList.remove("hcms-open","hcms-overlay","hcms-side-left")},restoreChrome(){Ni(s),x.classList.add("hcms-open"),r&&x.classList.add("hcms-overlay"),t==="left"&&x.classList.add("hcms-side-left")}}}function Ni(e){e&&(e.getElementById(Xe)||e.querySelector("style[data-hcms-bundled-styles]")||(ue.delete(e),Nr(e)))}function Nr(e){if(e&&!ue.has(e)){if(e[Oi]){ue.add(e);return}if(e.getElementById(Xe)||e.querySelector("style[data-hcms-bundled-styles]")){ue.add(e);return}if(Lt){let t=e.createElement("style");t.id=Xe,t.setAttribute("save-remove",""),t.textContent=Lt,(e.head||e.documentElement).appendChild(t),ue.add(e);return}try{let t=new URL("./theme.generated.css",Fi.url).href,r=e.createElement("link");r.rel="stylesheet",r.id=Xe,r.setAttribute("save-remove",""),r.href=t,(e.head||e.documentElement).appendChild(r),ue.add(e)}catch{}}}function Ii(e){let t=e.querySelector(".hcms-shell-body"),r=e.querySelector(".hcms-shell-header");if(!t||!r||typeof t.addEventListener!="function")return{detach(){}};let n=()=>{let i=(r.offsetHeight||0)-12;e.classList.toggle("is-condensed",t.scrollTop>i)};return t.addEventListener("scroll",n,{passive:!0}),n(),{detach(){t.removeEventListener("scroll",n)}}}function qi(e,t){function r(n){if(n.key!=="Tab"||!e.contains(t.activeElement))return;let i=Array.from(e.querySelectorAll(Li));if(i.length===0)return;let o=i[0],a=i[i.length-1];n.shiftKey&&t.activeElement===o?(n.preventDefault(),a.focus()):!n.shiftKey&&t.activeElement===a&&(n.preventDefault(),o.focus())}return t.addEventListener("keydown",r),{detach:()=>t.removeEventListener("keydown",r)}}var $i={skip:"[data-hcms-shell]",templateAttr:"cms-template"};function Ze(e,{ignoreActiveValue:t}={}){let r=F.findRules(e.doc,e.rulesSource||"cms");r&&(e.pageRules=r.rules,e.rulesTagNode=r.tagNode),Fe(e.doc),He(e.doc,e.pageRules),e.formRules=Be(e.pageRules,e.doc);let n=K(F.extract(e.pageRoot,e.pageRules,$i),e.pageRules),i=ze({pageRules:e.pageRules,formRules:e.formRules,data:n,doc:e.doc});Ne(e.formRoot,i,{ignoreActiveValue:t}),Rt(e),e.updateFingerprint&&e.updateFingerprint()}function Ir({debounce:e=100,onRefresh:t}){let r=typeof window<"u"&&window.hyperclay&&window.hyperclay.Mutation||null;if(!r||typeof r.onAnyChange!="function")throw new Error("hypercms: window.hyperclay.Mutation is required. Load hyperclayjs (or just the mutation utility) before initializing hypercms.");let n=0,i=r.onAnyChange({debounce:e},()=>{n>0||t()});return{unsubscribe:typeof i=="function"?i:()=>{},pause(){n++},resume(){n=Math.max(0,n-1)}}}var Di="[hypercms]";function qr(e,t){if(!e||!e.querySelectorAll||!t)return;let r=Pi(t);e.querySelectorAll("template[data-hcms-tpl]").forEach(i=>{let o=i.getAttribute("data-hcms-tpl");o&&(o.startsWith("@")||r.has(o)||console.warn(`${Di} template "${o}" doesn't match any rule path; ignored`))})}function Pi(e){let t=new Set;return r([],e),t;function r(n,i){let o=n.join("."),a=n.map(l=>typeof l=="number"?"*":l).join(".");o&&t.add(o),a&&t.add(a);let s=Z(i);if(s==="object")for(let[l,c]of Object.entries(i))r([...n,l],c);else if(s==="object-array"||s==="scalar-array"){let l=[...n,"*"],c=l.map(u=>typeof u=="number"?"*":u).join(".");if(t.add(c),s==="object-array"){let u=i[1];if(u&&typeof u=="object"&&!Array.isArray(u))for(let[m,h]of Object.entries(u))r([...l,m],h)}}}}function Dr(e){Lr(e)}var L={isOpen:!1,ctx:null,shell:null,opts:null};function Fr(e,t){if(L.ctx!==e)return;let r=t==="livesync";t==="livesync"&&L.shell?.restoreChrome?.(),Ze(e,{ignoreActiveValue:r})}var $r=!1;function Hi(){if($r)return;let e=typeof window<"u"&&window.hyperclay&&window.hyperclay.onPrepareForSave||null;typeof e=="function"&&(e(t=>{let r=t&&t.querySelector&&t.querySelector("body");r&&r.classList.remove("hcms-open","hcms-overlay","hcms-side-left")}),$r=!0)}function Pr(e={}){if(L.isOpen){console.warn("cms.open() called while already open; ignoring");return}Hi();let t=e.pageRoot||(typeof document<"u"?document.body:null);if(!t)throw new Error("hypercms: no pageRoot available");let r=t.ownerDocument||(typeof document<"u"?document:null);if(!r)throw new Error("hypercms: no document available");let n=e.rules!==void 0?e.rules:"cms",i=F.findRules(r,n);if(!i){let m=typeof n=="string"?`data-rules-name~="${n}"`:"the provided rules object";throw new Error(`hypercms: no rules found for ${m}`)}let o=i.rules,a=i.tagNode;Fe(r),He(r,o),qr(r,o);let s=Be(o,r),l=K(F.extract(t,o,{skip:"[data-hcms-shell]",templateAttr:"cms-template"}),o),c=Je(()=>jr({mountTo:e.mountTo||r.body,side:e.side||"right",overlay:!!e.overlay,showSaveButton:!!e.showSaveButton,title:e.title,eyebrow:e.eyebrow,theme:e.theme,doc:r})),u={doc:r,pageRoot:t,pageRules:o,formRules:s,rulesTagNode:a,rulesSource:n,formRoot:c.formRoot,shellRoot:c.root,errorEl:c.errorEl,lastFingerprint:null,lastData:null,observerHandle:null,undoUnsub:null,livesyncUnsub:null,onChange:e.onChange,onError:e.onError,confirmRemove:e.confirmRemove,previouslyFocused:r.activeElement,dispatch(m,h){let k=r.defaultView&&r.defaultView.CustomEvent||(typeof CustomEvent<"u"?CustomEvent:null);if(!k)return;let x=new k(m,{bubbles:!0,cancelable:m==="hcms:change",detail:h});c.root.dispatchEvent(x)},onCloseRequested(){Hr()}};u.updateFingerprint=()=>{u.lastFingerprint=Se($(u))};try{let m=ze({pageRules:o,formRules:s,data:l,doc:r});c.formRoot.appendChild(m),Mr(u),u.updateFingerprint(),u.observerHandle=Ir({onRefresh:()=>Ze(u)});let h=typeof window<"u"&&window.hyperclay&&window.hyperclay.undo||null;if(h&&typeof h.on=="function"){let x=()=>{if(L.ctx!==u)return;Fr(u,"undo");let T=K(F.extract(u.pageRoot,u.pageRules,{skip:"[data-hcms-shell]",templateAttr:"cms-template"}),u.pageRules);Se(T)!==Se(u.lastData)&&(u.lastData=T,u.onChange?.(T,{path:"",structural:!1}))};h.on("undo",x),h.on("redo",x),u.undoUnsub=()=>{h.off("undo",x),h.off("redo",x)}}let k=()=>Fr(u,"livesync");r.addEventListener("hyperclay:livesync-applied",k),u.livesyncUnsub=()=>r.removeEventListener("hyperclay:livesync-applied",k),_e.ctx=u,Bi(r),Ui(c.root),L.isOpen=!0,L.ctx=u,L.shell=c,L.opts=e,u.dispatch("hcms:open",{pageRoot:t})}catch(m){throw u.observerHandle?.unsubscribe?.(),u.undoUnsub?.(),u.livesyncUnsub?.(),u.detachEvents?.(),_e.ctx===u&&(_e.ctx=null),Je(()=>c.destroy()),L.isOpen=!1,L.ctx=null,L.shell=null,L.opts=null,m}}function Ui(e){let r=e.querySelector('input:not([disabled]):not([type="hidden"]), textarea:not([disabled]), select:not([disabled]), button:not([disabled]), [tabindex]:not([tabindex="-1"])');r&&typeof r.focus=="function"&&r.focus()}var _e={ctx:null};function Bi(e){let t=e.defaultView||(typeof globalThis<"u"?globalThis:null);if(!t)return;let r=function(){let i=_e.ctx;if(i)return Tt(i.formRoot),ce("Reorder",()=>B($(i),{path:"",structural:!0},i))};typeof t.hypercmsCommit!="function"&&(t.hypercmsCommit=r),typeof globalThis<"u"&&typeof globalThis.hypercmsCommit!="function"&&(globalThis.hypercmsCommit=r)}var Nt="cms";function zi(e){let t=typeof e=="string"?e:"",r=t.indexOf("?"),n=r===-1?t:t.slice(r+1);if(!n)return t;let i=new URLSearchParams(n);return i.get(Nt)!=="true"?t:(i.set(Nt,"false"),"?"+i.toString())}function Wi(e){let t=typeof e=="string"?e:"",r=t.indexOf("?"),n=r===-1?t:t.slice(r+1);return n?new URLSearchParams(n).get(Nt)==="true":!1}function Vi(){if(typeof window>"u"||!window.location||!window.history||typeof window.history.replaceState!="function")return;let e=window.location.search,t=zi(e);t!==e&&window.history.replaceState(window.history.state,"",t+window.location.hash)}function Hr(){if(!L.isOpen)return;let{ctx:e,shell:t}=L;e.closed=!0;let r=e.previouslyFocused;if(e.dispatch("hcms:close",null),Vi(),e.observerHandle?.unsubscribe?.(),e.undoUnsub?.(),e.livesyncUnsub?.(),e.detachEvents?.(),Je(()=>t.destroy()),L.isOpen=!1,L.ctx=null,L.shell=null,L.opts=null,_e.ctx=null,r&&typeof r.focus=="function")try{r.focus()}catch{}}function Ur(){L.isOpen&&Ze(L.ctx)}var Ki={getData(){return L.isOpen?$(L.ctx):null},setValue(e,t){if(!L.isOpen)throw new Error("hypercms: cms is not open");let r=L.ctx,n=W(e),i=X(r.pageRules,n);if(i===void 0)throw new Error(`hypercms: no rule at path "${e}"`);if(typeof i!="string"||i.endsWith("[]"))throw new Error(`hypercms: setValue requires a leaf scalar path; "${e}" is not a leaf`);let o=Gi(r.formRoot,e);if(!o)throw new Error(`hypercms: no field element at path "${e}"`);Yi(o,t,r.formRoot,e),B($(r),{path:e,structural:!1},r)},addItem(e){if(!L.isOpen)throw new Error("hypercms: cms is not open");Ct(e,L.ctx)},removeItem(e){if(!L.isOpen)throw new Error("hypercms: cms is not open");let t=L.ctx,r=W(e);if(typeof r[r.length-1]!="number")throw new Error(`hypercms: removeItem requires an item path; "${e}" is not an array index`);let i=X(t.pageRules,r.slice(0,-1));if(!(Array.isArray(i)||typeof i=="string"&&i.endsWith("[]")))throw new Error(`hypercms: removeItem requires an item path; parent of "${e}" is not an array`);let a=t.formRoot.querySelector(`[data-hcms-path="${qt(e)}"]`);if(!a)throw new Error(`hypercms: no element at path "${e}"`);le(a,t)},refresh:Ur,_commit(){if(!L.isOpen)return;let e=L.ctx;return Tt(e.formRoot),ce("Update",()=>B($(e),{path:"",structural:!0},e))}};function Gi(e,t){let r=qt(t),n=`[data-hcms-path="${r}"] input[data-hcms-field], [data-hcms-path="${r}"] textarea[data-hcms-field], [data-hcms-path="${r}"] select[data-hcms-field], [data-hcms-path="${r}"] img[data-hcms-field], [data-hcms-path="${r}"] a[data-hcms-field], [data-hcms-path="${r}"] [contenteditable][data-hcms-field], input[data-hcms-path="${r}"][data-hcms-field], textarea[data-hcms-path="${r}"][data-hcms-field], select[data-hcms-path="${r}"][data-hcms-field], img[data-hcms-path="${r}"][data-hcms-field], a[data-hcms-path="${r}"][data-hcms-field], [contenteditable][data-hcms-path="${r}"][data-hcms-field]`;return e.querySelector(n)}function Yi(e,t,r,n){let i=(e.tagName||"").toUpperCase(),o=(e.getAttribute("type")||"").toLowerCase();if(i==="INPUT"&&o==="checkbox"){e.checked=t===!0||t==="true";return}if(i==="INPUT"&&o==="radio"){let a=qt(n),s=r.querySelectorAll(`[data-hcms-path="${a}"][data-hcms-field][type="radio"], [data-hcms-path="${a}"] [data-hcms-field][type="radio"]`);s.length?s.forEach(l=>{l.checked=String(l.value)===String(t??"")}):e.checked=String(e.value)===String(t??"");return}if(i==="IMG"){e.src=t==null?"":String(t);return}if(i==="A"){e.href=t==null?"":String(t);return}if("value"in e){e.value=t==null?"":String(t);return}e.textContent=t==null?"":String(t)}var Ji=250,Xi=1e4;function Zi(){typeof window>"u"||typeof document>"u"||Wi(window.location?window.location.search:"")&&(L.isOpen||Qi(()=>{if(!L.isOpen)try{Pr()}catch(e){console.warn("hypercms: auto-open failed",e)}}))}function jt(){return!!document.body&&!!(window.hyperclay&&window.hyperclay.Mutation)}function Qi(e){if(jt()){e();return}let t=Date.now()+Xi,r=!1,n=null,i=()=>{r||(r=!0,n!==null&&clearInterval(n),document.removeEventListener("hyperclay:mutation-ready",o))};function o(){if(L.isOpen){i();return}jt()&&(i(),e())}document.addEventListener("hyperclay:mutation-ready",o,{once:!0}),n=setInterval(()=>{if(L.isOpen){i();return}if(jt()){i(),e();return}Date.now()>=t&&(i(),console.warn("hypercms: ?cms=true auto-open gave up \u2014 window.hyperclay.Mutation never appeared. Load hyperclayjs (or the mutation utility) so the CMS can initialize."))},Ji)}Zi();var It={open:Pr,close:Hr,refresh:Ur,api:Ki,get isOpen(){return L.isOpen},path:vt,scaffold:ke,morphForm:Ne};function qt(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^a-zA-Z0-9_\-.*]/g,t=>"\\"+t)}var Br=`/* GENERATED by scripts/build-theme.js from mirk-ui-kit/mirk.css \u2014 DO NOT EDIT.
